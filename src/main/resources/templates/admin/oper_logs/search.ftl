    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-12 col-sm-6 padding-6">
            <div class="form-group row col-xs-12 col-sm-12">
                <label class="col-sm-2 no-padding-right text-right">员工名</label>
                <div class="col-sm-10">
                    <input id="empName" class="form-control col-xs-10 col-sm-9"/>
                </div>
            </div>
            <div class="form-group row col-xs-12 col-sm-12">
                <label class="col-sm-2 no-padding-right text-right">操作日期</label>
                <div class="col-sm-10">
