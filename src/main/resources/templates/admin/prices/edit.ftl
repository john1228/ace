...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form action="/admin/rooms/0/devices/${device.id}/update" role="form" class="form-horizontal"
                          method="post">
                        <input type="hidden" name="_method" value="put">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                        <#--<@spring.formHiddenInput "device.id"/>-->
                        <@spring.formHiddenInput "device.accountId"/>
