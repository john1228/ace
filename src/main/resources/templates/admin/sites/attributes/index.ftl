            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="header smaller lighter blue">
                        <span>属性列表</span>
                        <a class="btn" style="float:right;margin-top: -12px;" href="/admin/sites/attributes/new"><i
                    ...
                    <script type="text/javascript">
                        $(function () {
                            $('#siteList').DataTable({
                                ...
                                ordering: false,
                                ajax: {
                                    url: "/admin/sites/attributes/dataList",
                                    type: "GET"
                                },
                                columns: [
                                    {
                                    ...
                                    {data: "value", className: 'center'},
                                    {
                                        data: "id",
                                        render: function (data) {
                                            return '<a class="btn btn-xs btn-info" href="/admin/sites/attributes/' + data + '"><i class="ace-icon fa fa-pencil bigger-120"></i></a>' +
                                                    '<a class="btn btn-xs btn-danger" href="/admin/sites/attributes/' + data + '/edit"><i class="ace-icon fa fa-edit bigger-120"></i></a>' +
