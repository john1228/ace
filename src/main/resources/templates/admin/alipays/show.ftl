    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="attribute-table">
                ...
                <div class="attribute-table-row">
                    <div class="attribute-table-label">私钥</div>
                    <div class="attribute-table-value">
                        ${alipay.privateKey!}
                    </div>
                </div>
                <div class="attribute-table-row">
                    <div class="attribute-table-label">公钥</div>
                    <div class="attribute-table-value">
                        ${alipay.publicKey!}
                    </div>
                </div>
                <div class="attribute-table-row">
                    ...
                    <div class="attribute-table-value">
                        ${alipay.createdAt?string("yyyy-MM-dd HH:mm:ss")}
                    </div>
                </div>
                <div class="attribute-table-row">
                    <div class="attribute-table-label">更新时间</div>
                    <div class="attribute-table-value">
                        ${alipay.updatedAt?string("yyyy-MM-dd HH:mm:ss")}
                    </div>
                </div>
            </div>
        </div>
