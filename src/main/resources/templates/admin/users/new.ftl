...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form action="/admin/user/save" role="form" class="form-horizontal" method="post" id="form_post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="用户账号" class="col-xs-10 col-sm-5"
                                       name="loginName"/>
                                <span style="color:red; height:25px;line-height:25px;overflow:hidden;"><b>&nbsp;*</b></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" placeholder="用户姓名 " class="col-xs-10 col-sm-5"
                                       name="userName"/>
                                <span style="color:red; height:25px;line-height:25px;overflow:hidden;"><b>&nbsp;*</b></span>
                            </div>
                        </div>
