<div class="main-content-inner">
                    ...
                    <div class="col-sm-6">
                        <div class="widget-box widget-color-blue2">
                            <div class="widget-header">
                                <h4 class="widget-title lighter smaller white">权限选择</h4>
                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <textarea spellcheck="false" readonly="readonly" id="tree-value"
                                              style="resize: none;"></textarea>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button class="btn btn-sm" data-dismiss="modal"><i class="icon-remove"></i> Cancel
                                </button>
                                <button class="btn btn-sm btn-primary" id="submit-ok"><i class="icon-ok"></i> OK
                                </button>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var remoteUrl = "/admin/users/${user.id}/perList.json";
            var remoteDateSource = function (openedParentData, callback) {
                $.ajax({
                    'type': 'post',
                    'url': remoteUrl,
            ...
            $("#submit-ok").on('click', function () {
                ...
                $.ajax({
                    url: '/admin/user/savepers',
                    data: {uid: ${user.id}, pids: pids},
                    dataType: "json",
