...
!function (t, e) {
    ...
    if (t = t && t.hasOwnProperty("default") ? t["default"] : t, Object.assign(t.DEFAULTS, {
        ...
        return {
            _init: function i() {
                var t = r.o_doc.body, e = r.o_doc.createElement("div");
                ...
                if ("object" === l(r.opts.tui)) {
                    var t = r.o_doc.createElement("div");
                    t.setAttribute("id", "tuieditor");
                    var i = r.o_doc.getElementById("tuiContainer");
                    i.appendChild(t), i.style.display = "block";
                    var n = e.image.get(), o = r.opts.imageTUIOptions;
                    o.includeUI.loadImage = {path: n[0].src, name: " "};
                    var a = new r.opts.tui.ImageEditor(r.o_doc.querySelector("#tuieditor"), o),
                        d = r.o_doc.getElementById("tuieditor");
                    d.style.minHeight = "590px", d.style.width = "94%", d.style.height = "94%", d.style.margin = "auto", s(".tui-image-editor-header-buttons").html('<button class="tui-editor-cancel-btn" data-cmd="cancel_tui_image">Cancel</button> <button class="tui-editor-save-btn">Save</button>'), s(".tui-editor-cancel-btn")[0].addEventListener("click", function (t) {
                        c(i)
                    }), s(".tui-editor-save-btn")[0].addEventListener("click", function (t) {
                        !function s(t, e, i) {
                            for (var n = t.toDataURL(), o = atob(n.split(",")[1]), a = [], d = 0; d < o.length; d++) a.push(o.charCodeAt(d));
                            var r = new Blob([new Uint8Array(a)], {type: "image/png"});
                            e.image.edit(i), e.image.upload([r])
                        }(a, e, n), c(i)
                    })
                }
            }
        ...
        title: "Advanced Edit", undo: !1, focus: !1, callback: function (t, e) {
