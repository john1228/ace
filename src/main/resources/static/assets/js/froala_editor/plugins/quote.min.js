...
!function (e, t) {
    ...
    "use strict";
    (e = e && e.hasOwnProperty("default") ? e["default"] : e).PLUGINS.quote = function (n) {
        var a = n.$;
        ...
        return {
            apply: function t(e) {
                n.selection.save(), n.html.wrap(!0, !0, !0, !0), n.selection.restore(), "increase" == e ? function r() {
                    var e, t = n.selection.blocks();
                    ...
                    var e, t = n.selection.blocks();
                    for (e = 0; e < t.length; e++) "BLOCKQUOTE" != t[e].tagName && (t[e] = a(t[e]).parentsUntil(n.$el, "BLOCKQUOTE").get(0));
                    for (n.selection.save(), e = 0; e < t.length; e++) t[e] && a(t[e]).replaceWith(t[e].innerHTML);
                    n.html.unwrap(), n.selection.restore()
                }()
            }
        }
        ...
        html: function () {
            ...
            for (var o in t) if (t.hasOwnProperty(o)) {
                var r = this.shortcuts.get("quote." + o);
                e += '<li role="presentation"><a class="fr-command fr-active ' + o + '" tabIndex="-1" role="option" data-cmd="quote" data-param1="' + o + '" title="' + t[o] + '">' + this.language.translate(t[o]) + (r ? '<span class="fr-shortcut">' + r + "</span>" : "") + "</a></li>"
            }
            return e += "</ul>"
        },
