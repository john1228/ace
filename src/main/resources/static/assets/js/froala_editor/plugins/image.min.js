...
!function (e, t) {
    ...
    Te = Te && Te.hasOwnProperty("default") ? Te["default"] : Te, Object.assign(Te.POPUP_TEMPLATES, {
        ...
        imageAddNewLine: !1
    }), Te.PLUGINS.image = function (g) {
        var d, l, f, p, o, a, c = g.$, s = "https://i.froala.com/upload", t = !1, i = 1, m = 2, u = 3, h = 4, v = 5,
            b = 6, r = {};
        ...
        function n() {
            ...
            if (e || (e = P()), e) {
                var t = ye();
                we() && (t = t.find(".fr-img-wrap")), g.popups.setContainer("image.edit", g.$sc), g.popups.refresh("image.edit");
        ...
        function C(e) {
            ...
            ce(e, t, a), e.removeClass("fr-dib fr-dii fr-fir fr-fil")
        }

        function A() {
            for (var e, t = "IMG" == g.el.tagName ? [g.el] : g.el.querySelectorAll("img"), a = 0; a < t.length; a++) {
                var i = c(t[a]);
                !g.opts.htmlUntouched && g.opts.useClasses ? ((g.opts.imageDefaultAlign || g.opts.imageDefaultDisplay) && (0 < (e = i).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption").first()), e.hasClass("fr-dii") || e.hasClass("fr-dib") || (e.addClass("fr-fi" + me(e)[0]), e.addClass("fr-di" + ue(e)[0]), e.css("margin", ""), e.css("float", ""), e.css("display", ""), e.css("z-index", ""), e.css("position", ""), e.css("overflow", ""), e.css("vertical-align", ""))), g.opts.imageTextNear || (0 < i.parents(".fr-img-caption").length ? i.parents(".fr-img-caption").first().removeClass("fr-dii").addClass("fr-dib") : i.removeClass("fr-dii").addClass("fr-dib"))) : g.opts.htmlUntouched || g.opts.useClasses || (g.opts.imageDefaultAlign || g.opts.imageDefaultDisplay) && C(i), g.opts.iframe && i.on("load", g.size.syncIframe)
            }
        }
        ...
        function E(e) {
            ...
            for (t = 0; t < a.length; t++) if (i.push(a[t].getAttribute("src")), c(a[t]).toggleClass("fr-draggable", g.opts.imageMove), "" === a[t].getAttribute("class") && a[t].removeAttribute("class"), "" === a[t].getAttribute("style") && a[t].removeAttribute("style"), a[t].parentNode && a[t].parentNode.parentNode && g.node.hasClass(a[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (o) for (t = 0; t < o.length; t++) i.indexOf(o[t].getAttribute("src")) < 0 && g.events.trigger("image.removed", [c(o[t])]);
            if (o && e) {
                var s = [];
        ...
        function S() {
            if (l || function s() {
                ...
                g.events.on("shared.destroy", function () {
                    ...
                    d && !d.hasClass("fr-uploading") ? fe(!0) : d && (S(), he(), O(!1))
                });
                if (g.opts.imageResize) {
                    ...
                    g.events.on("keydown", function (e) {
                        if (d) {
                            ...
                            (a !== r || 200 < e.timeStamp - n) && (i = 1), (a == Te.KEYCODE.EQUALS || g.browser.mozilla && a == Te.KEYCODE.FF_EQUALS) && t && !e.altKey ? i = Z.call(this, e, 1, 1, i) : (a == Te.KEYCODE.HYPHEN || g.browser.mozilla && a == Te.KEYCODE.FF_HYPHEN) && t && !e.altKey ? i = Z.call(this, e, 2, -1, i) : g.keys.ctrlKey(e) || a != Te.KEYCODE.ENTER || (d.before("<br>"), B(d)), r = a, n = e.timeStamp
                        }
        ...
        function D(e) {
            we() ? d.parents(".fr-img-caption").css("width", e) : d.css("width", e)
        }
        ...
        function x(e) {
            ...
            D(n), p.show(), g.popups.hideAll(), de()
        }
        ...
        function $(e) {
            ...
            if (f && d) {
                ...
                if ((f.hasClass("fr-hnw") || f.hasClass("fr-hsw")) && (i = 0 - i), g.opts.imageResizeWithPercent) {
                    ...
                    r = ((r + i) / c(n).outerWidth() * 100).toFixed(2), g.opts.imageRoundPercent && (r = Math.round(r)), D(r + "%"), (t = we() ? (g.helpers.getPX(d.parents(".fr-img-caption").css("width")) / c(n).outerWidth() * 100).toFixed(2) : (g.helpers.getPX(d.css("width")) / c(n).outerWidth() * 100).toFixed(2)) === r || g.opts.imageRoundPercent || D(t + "%"), d.css("height", "").removeAttr("height")
                } else r + i >= g.opts.imageMinWidth && (D(r + i), t = we() ? g.helpers.getPX(d.parents(".fr-img-caption").css("width")) : g.helpers.getPX(d.css("width"))), t !== r + i && D(t), ((d.attr("style") || "").match(/(^height:)|(; *height:)/) || d.attr("height")) && (d.css("height", f.data("start-height") * d.width() / f.data("start-width")), d.removeAttr("height"));
                S(), g.events.trigger("image.resize", [be()])
            }
        }
        ...
        function U(e) {
            ...
            if (f && d) {
                ...
                f = null, p.hide(), S(), n(), g.undo.saveStep(), g.events.trigger("image.resizeEnd", [be()])
            }
        }

        function I(e, t, a) {
            g.edit.on(), d && d.addClass("fr-error"), function i(e) {
                O();
                var t = g.popups.get("image.insert").find(".fr-image-progress-bar-layer");
                t.addClass("fr-error");
                var a = t.find("h3");
                a.text(e), g.events.disableBlur(), a.focus()
            }(g.language.translate("Something went wrong. Please try again.")), !d && a && ee(a), g.events.trigger("image.error", [{
                code: e,
                message: r[e]
            }, t, a])
        }
        ...
        function O(e) {
            ...
            if (t || (t = H()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), d) {
                ...
                var i = a.offset().left, r = a.offset().top + a.height();
        ...
        function k(e) {
            ...
            if (t && (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || g.$el.find("img.fr-error").length)) {
                if (g.events.focus(), g.$el.find("img.fr-error").length && (g.$el.find("img.fr-error").remove(), g.undo.saveStep(), g.undo.run(), g.undo.dropRedo()), !g.$wp && d) {
                    var a = d;
                    fe(!0), g.selection.setAfter(a.get(0)), g.selection.restore()
                }
        ...
        function T() {
            var e = c(this);
            g.popups.hide("image.insert"), e.removeClass("fr-uploading"), e.next().is("br") && e.next().remove(), B(e), g.events.trigger("image.loaded", [e])
        }

        function _(s, e, o, l, f) {
            ...
            t.onload = function () {
                ...
                if (l) {
                    ...
                    e.on("load", T), e.attr("src", s), g.edit.on(), E(!1), g.undo.saveStep(), g.events.disableBlur(), g.$el.blur(), g.events.trigger(a ? "image.replaced" : "image.inserted", [e, f])
                } else e = K(s, o, T), E(!1), g.undo.saveStep(), g.events.disableBlur(), g.$el.blur(), g.events.trigger("image.inserted", [e, f])
            }, t.onerror = function () {
                I(i)
        ...
        function K(e, t, a) {
            ...
            if (t && void 0 !== t) for (i in t) t.hasOwnProperty(i) && "link" != i && (" data-" + i + '="' + t[i] + '"', r.attr("data-str" + i, t[i]));
            var n = g.opts.imageDefaultWidth;
            n && "auto" != n && (n = g.opts.imageResizeWithPercent ? "100%" : n + "px"), r.attr("style", n ? "width: " + n + ";" : ""), ce(r, g.opts.imageDefaultDisplay, g.opts.imageDefaultAlign), r.on("load", a), r.on("error", a), g.edit.on(), g.events.focus(!0), g.selection.restore(), g.undo.saveStep(), g.opts.imageSplitHTML ? g.markers.split() : g.markers.insert(), g.html.wrap();
        ...
        function W(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === g.opts.imageUploadURL || g.opts.imageUploadURL == s) && !g.opts.imageUploadToS3) return function o(r, n) {
                    ...
                    s.onload = function () {
                        ...
                        if (s.result.indexOf("svg+xml") < 0) {
                            ...
                            e = window.URL.createObjectURL(new Blob([new Uint8Array(a)], {type: r.type})), g.image.insert(e, !1, null, n)
                        }
                    }, O(), s.readAsDataURL(r)
                }(i, t || d), !1;
                ...
                if (g.drag_support.formdata && (a = g.drag_support.formdata ? new FormData : null), a) {
                    ...
                    g.opts.imageUploadToS3 && (n = g.opts.imageUploadToS3.uploadURL ? g.opts.imageUploadToS3.uploadURL : "https://" + g.opts.imageUploadToS3.region + ".amazonaws.com/" + g.opts.imageUploadToS3.bucket), function l(t, a, e, r) {
                        function n() {
                            var e = c(this);
                            e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), g.placeholder.refresh(), B(e), S(), O(), g.edit.off(), t.onload = function () {
                                L.call(t, e)
                            }, t.onerror = M, t.upload.onprogress = z, t.onabort = Y, c(e.off("abortUpload")).on("abortUpload", function () {
                        ...
                        s.onload = function () {
                            ...
                            r ? (r.on("load", n), r.on("error", function () {
                                n(), c(this).off("error")
                            }), g.edit.on(), g.undo.saveStep(), r.data("fr-old-src", r.attr("src")), r.attr("src", e)) : K(e, null, n)
                        }, s.readAsDataURL(e)
        ...
        function V(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= g.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
                    ...
                    g.markers.remove(), g.markers.insertAtPoint(e.originalEvent), g.$el.find(".fr-marker").replaceWith(Te.MARKERS), 0 === g.$el.find(".fr-marker").length && g.selection.setAtEnd(g.el), g.popups.hideAll();
                    ...
                    return g.popups.show("image.insert", r, n), O(), 0 <= g.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, "")) ? (fe(!0), W(t.files)) : I(b), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        ...
        function H(e) {
            ...
            return 1 <= g.opts.imageInsertButtons.length && (a = g.popups.create("image.insert", f)), g.$wp && g.events.$on(g.$wp, "scroll", function () {
                d && g.popups.isVisible("image.insert") && he()
            }), function p(i) {
        ...
        function F() {
            ...
            e || (e = j()), k(), g.popups.refresh("image.alt"), g.popups.setContainer("image.alt", g.$sc);
            var t = ye();
            we() && (t = t.find(".fr-img-wrap"));
            var a = t.offset().left + t.outerWidth() / 2, i = t.offset().top + t.outerHeight();
            g.popups.show("image.alt", a, i, t.outerHeight(), !0)
        }

        function j(e) {
            if (e) return g.popups.onRefresh("image.alt", X), !0;
            var t = {
            ...
            return g.$wp && g.events.$on(g.$wp, "scroll.image-alt", function () {
                d && g.popups.isVisible("image.alt") && F()
            }), a
        }
        ...
        function Q() {
            var e = g.popups.get("image.size");
            e || (e = J()), k(), g.popups.refresh("image.size"), g.popups.setContainer("image.size", g.$sc);
            var t = ye();
            we() && (t = t.find(".fr-img-wrap"));
            var a = t.offset().left + t.outerWidth() / 2, i = t.offset().top + t.outerHeight();
        ...
        function ee(e) {
            (e = e || ye()) && !1 !== g.events.trigger("image.beforeRemove", [e]) && (g.popups.hideAll(), ve(), fe(!0), g.undo.canDo() || g.undo.saveStep(), e.get(0) == g.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (g.selection.setBefore(e.get(0).parentNode) || g.selection.setAfter(e.get(0).parentNode) || e.parent().after(Te.MARKERS), c(e.get(0).parentNode).remove()) : (g.selection.setBefore(e.get(0)) || g.selection.setAfter(e.get(0)) || e.after(Te.MARKERS), e.remove()), g.html.fillEmptyBlocks(), g.selection.restore()), g.undo.saveStep())
        }

        function te(e) {
            var t = e.which;
            if (d && (t == Te.KEYCODE.BACKSPACE || t == Te.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), ee(), !1;
            if (d && t == Te.KEYCODE.ESC) {
                var a = d;
                return fe(!0), g.selection.setAfter(a.get(0)), g.selection.restore(), e.preventDefault(), !1
            }
            if (!d || t != Te.KEYCODE.ARROW_LEFT && t != Te.KEYCODE.ARROW_RIGHT) return d && t === Te.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), fe(!0), !1) : d && t != Te.KEYCODE.F10 && !g.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0;
            var i = d.get(0);
            return fe(!0), t == Te.KEYCODE.ARROW_LEFT ? g.selection.setBefore(i) : g.selection.setAfter(i), g.selection.restore(), e.preventDefault(), !1
        }
        ...
        function ae(e) {
            ...
            } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var i = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), r = 0; r < i.length; r++) ae(i[r])
        }

        function ie(e) {
            if (!1 === g.events.trigger("image.beforePasteUpload", [e])) return !1;
            d = c(e), S(), n(), he(), O(), d.on("load", function () {
                S(), O(), c(this).off("load")
            });
            for (var t = c(e).attr("src").split(","), a = atob(t[1]), i = [], r = 0; r < a.length; r++) i.push(a.charCodeAt(r));
            W([new Blob([new Uint8Array(i)], {type: t[0].replace(/data\:/g, "").replace(/;base64/g, "")})], d)
        }
        ...
        function re() {
            g.opts.imagePaste ? g.$el.find("img[data-fr-image-pasted]").each(function (e, i) {
                if (g.opts.imagePasteProcess) {
                    ...
                    t && "auto" != t && (t += g.opts.imageResizeWithPercent ? "%" : "px"), c(i).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), ce(c(i), g.opts.imageDefaultDisplay, g.opts.imageDefaultAlign)
                }
                if (0 === i.src.indexOf("data:")) ie(i); else if (0 === i.src.indexOf("blob:") || 0 === i.src.indexOf("http") && g.opts.imageUploadRemoteUrls && g.opts.imageCORSProxy) {
                    var a = new Image;
        ...
        function ne(e) {
            ...
            i && ce(i, g.opts.imageDefaultDisplay, g.opts.imageDefaultAlign), g.events.trigger("paste.after")
        }
        ...
        function le(e) {
            ...
            for (var t = 0; t < Te.INSTANCES.length; t++) Te.INSTANCES[t] != g && Te.INSTANCES[t].events.trigger("image.hideResizer");
            g.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), g.helpers.isMobile() && (g.events.disableBlur(), g.$el.blur(), g.events.enableBlur()), g.opts.iframe && g.size.syncIframe(), d = c(this), ve(), S(), n(), g.browser.msie ? (g.popups.areVisible() && g.events.disableBlur(), g.win.getSelection && (g.win.getSelection().removeAllRanges(), g.win.getSelection().addRange(g.doc.createRange()))) : g.selection.clear(), g.helpers.isIOS() && (g.events.disableBlur(), g.$el.blur()), g.button.bulkRefresh(), g.events.trigger("video.hideResizer")
        }

        function fe(e) {
            d && (function t() {
                return pe
            }() || !0 === e) && (g.toolbar.enable(), l.removeClass("fr-active"), g.popups.hide("image.edit"), d = null, de(), f = null, p && p.hide())
        }
        ...
        function he() {
            ...
            e || (e = H()), g.popups.isVisible("image.insert") || (k(), g.popups.refresh("image.insert"), g.popups.setContainer("image.insert", g.$sc));
            var t = ye();
            we() && (t = t.find(".fr-img-wrap"));
            var a = t.offset().left + t.outerWidth() / 2, i = t.offset().top + t.outerHeight();
        ...
        function ye() {
            return we() ? d.parents(".fr-img-caption").first() : d
        }
        ...
        return {
            _init: function Ce() {
                ...
                (function e() {
                    g.events.$on(g.$el, g._mousedown, "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    }, !0), g.events.on("drop", V), g.events.on("element.beforeDrop", G), g.events.on("mousedown window.mousedown", ge), g.events.on("window.touchmove", de), g.events.on("mouseup window.mouseup", function () {
                        if (d) return fe(), !1;
                        de()
                        ...
                        d && (ve(), g.selection.clear())
                    }), g.events.on("image.resizeEnd", function () {
                        g.win.getSelection && B(d)
                        ...
                        g.node.isElement(t) && (g.opts.enter === Te.ENTER_BR ? e.after("<br>") : c(g.node.blockParent(e.get(0))).after("<" + g.html.defaultTag() + "><br></" + g.html.defaultTag() + ">"))
                    })
                })(), "IMG" == g.el.tagName && g.$el.addClass("fr-view"), g.events.$on(g.$el, g.helpers.isMobile() && !g.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', le), g.helpers.isMobile() && (g.events.$on(g.$el, "touchstart", "IMG" == g.el.tagName ? null : 'img:not([contenteditable="false"])', function () {
                    a = !1
                }), g.events.$on(g.$el, "touchmove", function () {
                    a = !0
                })), g.$wp ? (g.events.on("window.keydown keydown", te, !0), g.events.on("keyup", function (e) {
                    if (d && e.which == Te.KEYCODE.ENTER) return !1
                ...
                })) : g.events.$on(g.$win, "keydown", te), g.events.on("toolbar.esc", function () {
                    if (d) {
                        if (g.$wp) g.events.disableBlur(), g.events.focus(); else {
                            var e = d;
                            fe(!0), g.selection.setAfter(e.get(0)), g.selection.restore()
                        }
                        return !1
                    }
                    ...
                    if (d && g.popups.isVisible("image.edit") && !g.popups.get("image.edit").find(":focus").length) {
                        var t = ye();
                        we() ? (t.before(Te.START_MARKER), t.after(Te.END_MARKER), g.selection.restore(), g.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ve(), g.paste.saveCopiedText(d.get(0).outerHTML, d.attr("alt"))), "copy" == e.type ? setTimeout(function () {
                            B(d)
                        }) : (fe(!0), g.undo.saveStep(), setTimeout(function () {
                            g.undo.saveStep()
                        }, 0))
                    }
                    ...
                    var t = e.which;
                    t == Te.KEYCODE.C && g.keys.ctrlKey(e) ? g.events.trigger("window.copy") : t == Te.KEYCODE.X && g.keys.ctrlKey(e) && g.events.trigger("window.cut")
                }), g.events.$on(c(g.o_win), "keydown", function (e) {
                    var t = e.which;
                    if (d && t == Te.KEYCODE.BACKSPACE) return e.preventDefault(), !1
                }), g.events.$on(g.$win, "keydown", function (e) {
                    var t = e.which;
                    d && d.hasClass("fr-uploading") && t == Te.KEYCODE.ESC && d.trigger("abortUpload")
                }), g.events.on("destroy", function () {
                    d && d.hasClass("fr-uploading") && d.trigger("abortUpload")
                }), g.events.on("paste.before", se), g.events.on("paste.beforeCleanup", oe), g.events.on("paste.after", re), g.events.on("html.set", A), g.events.on("html.inserted", A), A(), g.events.on("destroy", function () {
                    o = []
                }), g.events.on("html.processGet", ae), g.opts.imageOutputSize && g.events.on("html.beforeGet", function () {
                ...
                }), P(!0), H(!0), J(!0), j(!0), g.events.on("node.remove", function (e) {
            ...
            showInsertPopup: function Ae() {
                ...
                if (t || (t = H()), k(), !t.hasClass("fr-active")) if (g.popups.refresh("image.insert"), g.popups.setContainer("image.insert", g.$tb), e.isVisible()) {
                    var a = g.button.getPosition(e), i = a.left, r = a.top;
            ...
            showLayer: function Ee(e) {
                ...
                if (d || g.opts.toolbarInline) {
                    if (d) {
                        var r = ye();
                        we() && (r = r.find(".fr-img-wrap")), a = r.offset().top + r.outerHeight(), t = r.offset().left
                    }
                } else {
            ...
            insertByURL: function De() {
                ...
                if (0 < e.val().length) {
                    ...
                    if (g.opts.imageUploadRemoteUrls && g.opts.imageCORSProxy && g.opts.imageUpload) {
                        ...
                        a.onload = function () {
                            200 == this.status ? W([new Blob([this.response], {type: this.response.type || "image/png"})], d) : I(i)
                        }, a.onerror = function () {
                            _(t, !0, [], d)
            ...
            align: function xe(e) {
                var t = ye();
                t.removeClass("fr-fir fr-fil"), !g.opts.htmlUntouched && g.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : ce(t, ue(), e), ve(), S(), n(), g.selection.clear()
            },
            refreshAlign: function $e(e) {
                d && e.find("> *").first().replaceWith(g.icon.create("image-align-" + me()))
            },
            refreshAlignOnShow: function Ue(e, t) {
                d && t.find('.fr-command[data-param1="' + me() + '"]').addClass("fr-active").attr("aria-selected", !0)
            },
            display: function Ie(e) {
                var t = ye();
                t.removeClass("fr-dii fr-dib"), !g.opts.htmlUntouched && g.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : ce(t, e, me()), ve(), S(), n(), g.selection.clear()
            },
            ...
            replace: he,
            back: function e() {
                d ? (g.events.disableBlur(), c(".fr-popup input:focus").blur(), B(d)) : (g.events.disableBlur(), g.selection.restore(), g.events.enableBlur(), g.popups.hide("image.insert"), g.toolbar.showInline())
            },
            get: be,
            getEl: ye,
            insert: _,
            ...
            applyStyle: function Oe(e, t, a) {
                ...
                "object" == _e(t[e]) ? (i.removeAttr("style"), i.css(t[e].style)) : i.toggleClass(e), B(d)
            },
            showAltPopup: F,
            showSizePopup: Q,
            setAlt: function ke(e) {
                if (d) {
                    ...
                    d.attr("alt", e || t.find("input").val() || ""), t.find("input:focus").blur(), B(d)
                }
            },
            ...
            toggleCaption: function Be() {
                ...
                if (d && !we()) {
                    ...
                    e.wrap("<span " + (g.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + d.attr("class") + '" style="' + (g.opts.useClasses ? "" : e.attr("style")) + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), d.after('<span class="fr-inner"' + (g.browser.mozilla ? "" : ' contenteditable="true"') + ">" + Te.START_MARKER + g.language.translate("Image Caption") + Te.END_MARKER + "</span>"), d.removeAttr("class").removeAttr("style").removeAttr("width"), d.parents(".fr-img-caption").css("width", i), fe(!0), g.selection.restore()
                } else e = ye(), d.insertAfter(e), d.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), B(d)
            },
            hasCaption: we,
            exitEdit: fe,
            edit: B
        }
    }, Te.DefineIcon("insertImage", {
        NAME: "image",
        SVG_KEY: "insertImage"
    }), Te.RegisterShortcut(Te.KEYCODE.P, "insertImage", null, "P"), Te.RegisterCommand("insertImage", {
        title: "Insert Image",
        undo: !1,
        focus: !0,
        ...
        plugin: "image"
    }), Te.DefineIcon("imageUpload", {
        NAME: "upload",
        SVG_KEY: "upload"
    }), Te.RegisterCommand("imageUpload", {
        title: "Upload Image",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.DefineIcon("imageDisplay", {
        NAME: "star",
        SVG_KEY: "imageDisplay"
    }), Te.RegisterCommand("imageDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }), Te.DefineIcon("image-align", {
        NAME: "align-left",
        SVG_KEY: "alignLeft"
    }), Te.DefineIcon("image-align-left", {
        NAME: "align-left",
        SVG_KEY: "alignLeft"
    }), Te.DefineIcon("image-align-right", {
        NAME: "align-right",
        SVG_KEY: "alignRight"
    }), Te.DefineIcon("image-align-center", {
        NAME: "align-justify",
        SVG_KEY: "alignCenter"
    }), Te.DefineIcon("imageAlign", {
        NAME: "align-justify",
        SVG_KEY: "alignJustify"
    }), Te.RegisterCommand("imageAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.COMMANDS.imageAlign.options;
    ...
    }), Te.RegisterCommand("imageReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), Te.DefineIcon("imageRemove", {
        NAME: "trash",
        SVG_KEY: "remove"
    }), Te.RegisterCommand("imageRemove", {
        title: "Remove", callback: function () {
            this.image.remove()
        }
    }), Te.DefineIcon("imageBack", {
        NAME: "arrow-left",
        SVG_KEY: "back"
    }), Te.RegisterCommand("imageBack", {
    ...
    }), Te.RegisterCommand("imageDismissError", {
        title: "OK", undo: !1, callback: function () {
            this.image.hideProgressBar(!0)
        }
    }), Te.DefineIcon("imageStyle", {
        NAME: "magic",
        SVG_KEY: "imageClass"
    }), Te.RegisterCommand("imageStyle", {
        title: "Style", type: "dropdown", html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = this.opts.imageStyles;
            for (var a in t) if (t.hasOwnProperty(a)) {
                var i = t[a];
                "object" == _e(i) && (i = i.title), e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="imageStyle" data-param1="' + a + '">' + this.language.translate(i) + "</a></li>"
            }
            return e += "</ul>"
        }, callback: function (e, t) {
    ...
    }), Te.DefineIcon("imageAlt", {NAME: "info", SVG_KEY: "imageAltText"}), Te.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), Te.RegisterCommand("imageSetAlt", {
        undo: !0,
        focus: !1,
        title: "Update",
        refreshAfterCallback: !1,
    ...
    }), Te.DefineIcon("imageSize", {
        NAME: "arrows-alt",
        SVG_KEY: "imageSize"
    }), Te.RegisterCommand("imageSize", {
        undo: !1, focus: !1, popup: !0, title: "Change Size", callback: function () {
            this.image.showSizePopup()
        }
    }), Te.RegisterCommand("imageSetSize", {
        undo: !0,
        focus: !1,
        title: "Update",
        refreshAfterCallback: !1,
    ...
    }), Te.DefineIcon("imageCaption", {
        NAME: "commenting",
        FA5NAME: "comment-alt",
        SVG_KEY: "imageCaption"
    }), Te.RegisterCommand("imageCaption", {
        undo: !0,
        focus: !1,
        title: "Image Caption",
