...
!function (e, t) {
    ...
    }), e.PLUGINS.help = function (d) {
        var a, o = d.$, s = "help";
        return {
            _init: function e() {
            }, show: function c() {
                if (!a) {
                    var e = "<h4>" + d.language.translate("Shortcuts") + "</h4>", t = function n() {
                        for (var e = '<div class="fr-help-modal">', t = 0; t < d.opts.helpSets.length; t++) {
                            var l = d.opts.helpSets[t], a = "<table>";
                            a += "<thead><tr><th>" + d.language.translate(l.title) + "</th></tr></thead>", a += "<tbody>";
                            for (var o = 0; o < l.commands.length; o++) {
                                var s = l.commands[o];
                                a += "<tr>", a += "<td>" + d.language.translate(s.desc) + "</td>", a += "<td>" + s.val.replace("OSkey", d.helpers.isMac() ? "&#8984;" : "Ctrl+") + "</td>", a += "</tr>"
                            }
                            e += a += "</tbody></table>"
                        }
                        return e += "</div>"
                    }(), l = d.modals.create(s, e, t);
                    a = l.$modal, d.events.$on(o(d.o_win), "resize", function () {
                        d.modals.resize(s)
                    })
                }
                d.modals.show(s), d.modals.resize(s)
            }, hide: function t() {
                d.modals.hide(s)
            }
        }
