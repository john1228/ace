    ...
    e = e && e.hasOwnProperty("default") ? e["default"] : e, Object.assign(e.DEFAULTS, {
        ...
        return {
            _init: function e() {
                ...
                a.selection.save();
                for (var i = 0; i < t.length; i++) r(t[i]).css("line-height", e), "" === r(t[i]).attr("style") && r(t[i]).removeAttr("style");
                a.html.unwrap(), a.selection.restore()
            }, refreshOnShow: function l(e, t) {
                var i = a.selection.blocks();
                if (i.length) {
                    var n = r(i[0]);
        ...
        type: "dropdown", html: function () {
            ...
            for (var i in t) t.hasOwnProperty(i) && (e += '<li role="presentation"><a class="fr-command ' + i + '" tabIndex="-1" role="option" data-cmd="lineHeight" data-param1="' + t[i] + '" title="' + this.language.translate(i) + '">' + this.language.translate(i) + "</a></li>");
            return e += "</ul>"
