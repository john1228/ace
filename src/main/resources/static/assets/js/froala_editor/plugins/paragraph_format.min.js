...
!function (a, t) {
    ...
    a = a && a.hasOwnProperty("default") ? a["default"] : a, Object.assign(a.DEFAULTS, {
    ...
    }), a.PLUGINS.paragraphFormat = function (m) {
        var f = m.$;

        function g(a, t) {
            var e = m.html.defaultTag();
            if (t && t.toLowerCase() != e) if (0 < a.find("ul, ol").length) {
                var r = f("<" + t + ">");
                a.prepend(r);
                for (var n = m.node.contents(a.get(0))[0]; n && ["UL", "OL"].indexOf(n.tagName) < 0;) {
                    var o = n.nextSibling;
                    r.append(n), n = o
                }
        ...
        return {
            apply: function c(a) {
                "N" == a && (a = m.html.defaultTag()), m.selection.save(), m.html.wrap(!0, !0, !m.opts.paragraphFormat.BLOCKQUOTE, !0, !0), m.selection.restore();
                var t, e, r, n, o, i, l, p, s = m.selection.blocks();
                m.selection.save(), m.$el.find("pre").attr("skip", !0);
                for (var d = 0; d < s.length; d++) if (s[d].tagName != a && !m.node.isList(s[d])) {
                    var h = f(s[d]);
                    "LI" == s[d].tagName ? g(h, a) : "LI" == s[d].parentNode.tagName && s[d] ? (i = h, l = a, p = m.html.defaultTag(), l && l.toLowerCase() != p || (l = 'div class="fr-temp-div"'), i.replaceWith(f("<" + l + ">").html(i.html()))) : 0 <= ["TD", "TH"].indexOf(s[d].parentNode.tagName) ? (r = h, n = a, o = m.html.defaultTag(), n || (n = 'div class="fr-temp-div"' + (m.node.isEmpty(r.get(0), !0) ? ' data-empty="true"' : "")), n.toLowerCase() == o ? (m.node.isEmpty(r.get(0), !0) || r.append("<br/>"), r.replaceWith(r.html())) : r.replaceWith(f("<" + n + ">").html(r.html()))) : (t = h, (e = a) || (e = 'div class="fr-temp-div"' + (m.node.isEmpty(t.get(0), !0) ? ' data-empty="true"' : "")), t.replaceWith(f("<" + e + " " + m.node.attributes(t.get(0)) + ">").html(t.html()).removeAttr("data-empty")))
                }
                m.$el.find('pre:not([skip="true"]) + pre:not([skip="true"])').each(function () {
                    f(this).prev().append("<br>" + f(this).html()), f(this).remove()
                }), m.$el.find("pre").removeAttr("skip"), m.html.unwrap(), m.selection.restore()
            }, refreshOnShow: function i(a, t) {
                var e = m.selection.blocks();
                if (e.length) {
                    var r = e[0], n = "N", o = m.html.defaultTag();
                    r.tagName.toLowerCase() != o && r != m.el && (n = r.tagName), t.find('.fr-command[data-param1="' + n + '"]').addClass("fr-active").attr("aria-selected", !0)
                } else t.find('.fr-command[data-param1="N"]').addClass("fr-active").attr("aria-selected", !0)
            }, refresh: function o(a) {
                if (m.opts.paragraphFormatSelection) {
                    var t = m.selection.blocks();
                    if (t.length) {
                        var e = t[0], r = "N", n = m.html.defaultTag();
                        e.tagName.toLowerCase() != n && e != m.el && (r = e.tagName), 0 <= ["LI", "TD", "TH"].indexOf(r) && (r = "N"), a.find(">span").text(m.language.translate(m.opts.paragraphFormat[r]))
                    } else a.find(">span").text(m.language.translate(m.opts.paragraphFormat.N))
                }
            }
        }
