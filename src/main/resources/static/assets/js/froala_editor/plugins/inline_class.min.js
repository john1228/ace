...
!function (n, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(require("froala-editor")) : "function" == typeof define && define.amd ? define(["froala-editor"], e) : e(n.FroalaEditor)
}(this, function (n) {
    "use strict";
    n = n && n.hasOwnProperty("default") ? n["default"] : n, Object.assign(n.DEFAULTS, {
    ...
    }), n.PLUGINS.inlineClass = function (a) {
        var i = a.$;
        return {
            apply: function e(n) {
                a.format.toggle("span", {"class": n})
            }, refreshOnShow: function s(n, e) {
                e.find(".fr-command").each(function () {
                    var n = i(this).data("param1"), e = a.format.is("span", {"class": n});
        ...
        type: "dropdown", title: "Inline Class", html: function () {
            ...
            for (var a in e) e.hasOwnProperty(a) && (n += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="inlineClass" data-param1="' + a + '" title="' + e[a] + '">' + e[a] + "</a></li>");
            return n += "</ul>"
