...
!function (e, t) {
    ...
    "use strict";
    (e = e && e.hasOwnProperty("default") ? e["default"] : e).PLUGINS.codeBeautifier = function () {
        var e, t, n, i, Q = {};
        ...
        function y(i, e) {
            ...
            var R = i.match(/^[\t ]*/)[0], m = new Array(r + 1).join(s), b = 0, v = 0;
            for (var S, A, k = {
                "{": function (e) {
                ...
                if ("/" === h && "*" === f()) {
                    var V = 0 === b;
                    (I || V) && k.newLine(), y.push(x()), k.newLine(), V && k.newLine(!0)
                } else if ("/" === h && "/" === f()) I || "{" === L || k.trim(), k.singleSpace(), y.push(x()), k.newLine(); else if ("@" === h) {
                    k.preserveSingleSpace(), y.push(h);
                    var P = (void 0, S = u, A = T(": , {}()[]/='\""), u = S - 1, d(), A);
                    P.match(/[ :]$/) && (d(), P = T(": ").replace(/\s$/, ""), y.push(P), k.singleSpace()), (P = P.replace(/\s$/, "")) in t && (v += 1, P in n && (D = !0))
                } else "#" === h && "{" === f() ? (k.preserveSingleSpace(), y.push(T("}"))) : "{" === h ? "}" === f(!0) ? (E(), d(), k.singleSpace(), y.push("{}"), k.newLine(), o && 0 === b && k.newLine(!0)) : (b++, R += m, k["{"](h), O = D ? (D = !1, v < b) : v <= b) : "}" === h ? (b--, R = R.slice(0, -r), k["}"](h), N = O = !1, v && v--, o && 0 === b && k.newLine(!0)) : ":" === h ? (E(), !O && !D || w("&") || K() ? ":" === f() ? (d(), y.push("::")) : y.push(":") : (N = !0, y.push(":"), k.singleSpace())) : '"' === h || "'" === h ? (k.preserveSingleSpace(), y.push(T(h))) : " " === h ? (N = !1, y.push(h), k.newLine()) : "(" === h ? w("url") ? (y.push(h), E(), d() && (")" !== h && '"' !== h && "'" !== h ? y.push(T(")")) : u--)) : (p++, k.preserveSingleSpace(), y.push(h), E()) : ")" === h ? (y.push(h), p--) : "," === h ? (y.push(h), E(), _ && !N && p < 1 ? k.newLine() : k.singleSpace()) : ("]" === h || ("[" === h ? k.preserveSingleSpace() : "=" === h ? (E(), h = "=") : k.preserveSingleSpace()), y.push(h))
            }
            var B = "";
            return R && (B += R), B += y.join("").replace(/[\r\n\t ]+$/, ""), a && (B += "\n"), "\n" != l && (B = B.replace(/[\n]/g, l)), B
        }
        ...
        function r(i, e) {
            var l, r, s, h, _, a, o, c, u, t, n, p, d, f = [], T = "";

            function E(e, t) {
                var n = 0;
                return e && (n = e.indentation_level, !l.just_added_newline() && e.line_indent_level > n && (n = e.line_indent_level)), {
                    mode: t,
                    parent: e,
                    ...
                    start_line_index: l.get_line_number(),
                    ternary_depth: 0
                }
            }
            ...
            for (p = {
                TK_START_EXPR: function L() {
                    ...
                    var e = Z.Expression;
                    if ("[" === h.text) {
                        if ("TK_WORD" === _ || ")" === c.last_text) return "TK_RESERVED" === _ && Y(c.last_text, s.line_starters) && (l.space_before_token = !0), v(e), m(), b(), void(d.space_in_paren && (l.space_before_token = !0));
                        e = Z.ArrayLiteral, S(c.mode) && ("[" !== c.last_text && ("," !== c.last_text || "]" !== a && "}" !== a) || d.keep_array_indentation || K())
                    } else "TK_RESERVED" === _ && "for" === c.last_text ? e = Z.ForInitializer : "TK_RESERVED" === _ && Y(c.last_text, ["if", "while"]) && (e = Z.Conditional);
                    " " === c.last_text || "TK_START_BLOCK" === _ ? K() : "TK_END_EXPR" === _ || "TK_START_EXPR" === _ || "TK_END_BLOCK" === _ || "." === c.last_text ? w(h.wanted_newline) : "TK_RESERVED" === _ && "(" === h.text || "TK_WORD" === _ || "TK_OPERATOR" === _ ? "TK_RESERVED" === _ && ("function" === c.last_word || "typeof" === c.last_word) || "*" === c.last_text && "function" === a ? d.space_after_anon_function && (l.space_before_token = !0) : "TK_RESERVED" !== _ || !Y(c.last_text, s.line_starters) && "catch" !== c.last_text || d.space_before_conditional && (l.space_before_token = !0) : l.space_before_token = !0;
                    "(" === h.text && "TK_RESERVED" === _ && "await" === c.last_word && (l.space_before_token = !0);
                    "(" === h.text && ("TK_EQUALS" !== _ && "TK_OPERATOR" !== _ || y() || w());
                    v(e), m(), d.space_in_paren && (l.space_before_token = !0);
                    b()
                }, TK_END_EXPR: function I() {
                    for (; c.mode === Z.Statement;) k();
                    c.multiline_frame && w("]" === h.text && S(c.mode) && !d.keep_array_indentation);
                    d.space_in_paren && ("TK_START_EXPR" !== _ || d.space_in_empty_paren ? l.space_before_token = !0 : (l.trim(), l.space_before_token = !1));
                    "]" === h.text && d.keep_array_indentation ? (m(), k()) : (k(), m());
                    l.remove_redundant_indentation(u), c.do_while && u.mode === Z.Conditional && (u.mode = Z.Expression, c.do_block = !1, c.do_while = !1)
                }, TK_START_BLOCK: function V() {
                    var e = D(1), t = D(2);
                    t && (":" === t.text && Y(e.type, ["TK_STRING", "TK_WORD", "TK_RESERVED"]) || Y(e.text, ["get", "set"]) && Y(t.type, ["TK_WORD", "TK_RESERVED"])) ? Y(a, ["class", "interface"]) ? v(Z.BlockStatement) : v(Z.ObjectLiteral) : v(Z.BlockStatement);
                    var n = !e.comments_before.length && "}" === e.text && "function" === c.last_word && "TK_END_EXPR" === _;
                    "expand" === d.brace_style || "none" === d.brace_style && h.wanted_newline ? "TK_OPERATOR" !== _ && (n || "TK_EQUALS" === _ || "TK_RESERVED" === _ && N(c.last_text) && "else" !== c.last_text) ? l.space_before_token = !0 : K(!1, !0) : "TK_OPERATOR" !== _ && "TK_START_EXPR" !== _ ? "TK_START_BLOCK" === _ ? K() : l.space_before_token = !0 : S(u.mode) && "," === c.last_text && ("}" === a ? l.space_before_token = !0 : K());
                    m(), b()
                }, TK_END_BLOCK: function P() {
                    for (; c.mode === Z.Statement;) k();
                    var e = "TK_START_BLOCK" === _;
                    "expand" === d.brace_style ? e || K() : e || (S(c.mode) && d.keep_array_indentation ? (d.keep_array_indentation = !1, K(), d.keep_array_indentation = !0) : K());
                    k(), m()
                }, TK_WORD: C, TK_RESERVED: C, TK_SEMICOLON: function B() {
                    O() && (l.space_before_token = !1);
                    for (; c.mode === Z.Statement && !c.if_block && !c.do_block;) k();
                    m()
                }, TK_STRING: function j() {
                    O() ? l.space_before_token = !0 : "TK_RESERVED" === _ || "TK_WORD" === _ ? l.space_before_token = !0 : "TK_COMMA" === _ || "TK_START_EXPR" === _ || "TK_EQUALS" === _ || "TK_OPERATOR" === _ ? y() || w() : K();
                    m()
                }, TK_EQUALS: function M() {
                    O();
                    c.declaration_statement && (c.declaration_assignment = !0);
                    l.space_before_token = !0, m(), l.space_before_token = !0
                }, TK_OPERATOR: function U() {
                    O();
                    if ("TK_RESERVED" === _ && N(c.last_text)) return l.space_before_token = !0, void m();
                    if ("*" === h.text && "TK_DOT" === _) return void m();
                    if (":" === h.text && c.in_case) return c.case_body = !0, b(), m(), K(), void(c.in_case = !1);
                    if ("::" === h.text) return void m();
                    "TK_OPERATOR" === _ && w();
                    var e = !0, t = !0;
                    Y(h.text, ["--", "++", "!", "~"]) || Y(h.text, ["-", "+"]) && (Y(_, ["TK_START_BLOCK", "TK_START_EXPR", "TK_EQUALS", "TK_OPERATOR"]) || Y(c.last_text, s.line_starters) || "," === c.last_text) ? (t = e = !1, !h.wanted_newline || "--" !== h.text && "++" !== h.text || K(!1, !0), " " === c.last_text && A(c.mode) && (e = !0), "TK_RESERVED" === _ ? e = !0 : "TK_END_EXPR" === _ ? e = !("]" === c.last_text && ("--" === h.text || "++" === h.text)) : "TK_OPERATOR" === _ && (e = Y(h.text, ["--", "-", "++", "+"]) && Y(c.last_text, ["--", "-", "++", "+"]), Y(h.text, ["+", "-"]) && Y(c.last_text, ["--", "++"]) && (t = !0)), c.mode !== Z.BlockStatement && c.mode !== Z.Statement || "{" !== c.last_text && " " !== c.last_text || K()) : ":" === h.text ? 0 === c.ternary_depth ? e = !1 : c.ternary_depth -= 1 : "?" === h.text ? c.ternary_depth += 1 : "*" === h.text && "TK_RESERVED" === _ && "function" === c.last_text && (t = e = !1);
                    l.space_before_token = l.space_before_token || e, m(), l.space_before_token = t
                }, TK_COMMA: function W() {
                    if (c.declaration_statement) return A(c.parent.mode) && (c.declaration_assignment = !1), m(), void(c.declaration_assignment ? K(c.declaration_assignment = !1, !0) : (l.space_before_token = !0, d.comma_first && w()));
                    m(), c.mode === Z.ObjectLiteral || c.mode === Z.Statement && c.parent.mode === Z.ObjectLiteral ? (c.mode === Z.Statement && k(), K()) : (l.space_before_token = !0, d.comma_first && w())
                }, TK_BLOCK_COMMENT: function z() {
                    if (l.raw) return l.add_raw_token(h), void(h.directives && "end" === h.directives.preserve && (d.test_output_raw || (l.raw = !1)));
                    if (h.directives) return K(!1, !0), m(), "start" === h.directives.preserve && (l.raw = !0), void K(!1, !0);
                    if (!Q.newline.test(h.text) && !h.wanted_newline) return l.space_before_token = !0, m(), void(l.space_before_token = !0);
                    var e, t = function _(e) {
                        var t;
                        e = e.replace(/\x0d/g, "");
                        var n = [];
                        t = e.indexOf("\n");
                        ...
                        e.length && n.push(e);
                        return n
                    }(h.text), n = !1, i = !1, r = h.whitespace_before, s = r.length;
                    K(!1, !0), 1 < t.length && (!function a(e, t) {
                        for (var n = 0; n < e.length; n++) {
                            var i = H(e[n]);
                            if (i.charAt(0) !== t) return !1
                        }
                        return !0
                    }(t.slice(1), "*") ? function o(e, t) {
                        for (var n, i = 0, r = e.length; i < r; i++) if ((n = e[i]) && 0 !== n.indexOf(t)) return !1;
                        return !0
                    }(t.slice(1), r) && (i = !0) : n = !0);
                    for (m(t[0]), e = 1; e < t.length; e++) K(!1, !0), n ? m(" " + t[e].replace(/^\s+/g, "")) : i && t[e].length > s ? m(t[e].substring(s)) : l.add_token(t[e]);
                    K(!1, !0)
                }, TK_COMMENT: function G() {
                    h.wanted_newline ? K(!1, !0) : l.trim(!0);
                    l.space_before_token = !0, m(), K(!1, !0)
                }, TK_DOT: function X() {
                    O();
                    "TK_RESERVED" === _ && N(c.last_text) ? l.space_before_token = !0 : w(")" === c.last_text && d.break_chained_methods);
                    m()
                }, TK_UNKNOWN: function F() {
                    m(), "\n" === h.text[h.text.length - 1] && K()
                }, TK_EOF: function $() {
                    for (; c.mode === Z.Statement;) k()
                }
            ...
            function x(e) {
                var t = e.newlines;
                if (d.keep_array_indentation && S(c.mode)) for (var n = 0; n < t; n += 1) K(0 < n); else if (d.max_preserve_newlines && t > d.max_preserve_newlines && (t = d.max_preserve_newlines), d.preserve_newlines && 1 < e.newlines) {
                    K();
            ...
            function w(e) {
                if (e = e !== undefined && e, !l.just_added_newline()) if (d.preserve_newlines && h.wanted_newline || e) K(!1, !0); else if (d.wrap_line_length) {
                    l.current_line.get_character_count() + h.text.length + (l.space_before_token ? 1 : 0) >= d.wrap_line_length && K(!1, !0)
                }
            }

            function K(e, t) {
                if (!t && " " !== c.last_text && "," !== c.last_text && "=" !== c.last_text && "TK_OPERATOR" !== _) for (; c.mode === Z.Statement && !c.if_block && !c.do_block;) k();
                l.add_new_line(e) && (c.multiline_frame = !0)
            }

            function R() {
                l.just_added_newline() && (d.keep_array_indentation && S(c.mode) && h.wanted_newline ? (l.current_line.push(h.whitespace_before), l.space_before_token = !1) : l.set_indent(c.indentation_level) && (c.line_indent_level = c.indentation_level))
            }

            function m(e) {
                l.raw ? l.add_raw_token(h) : (d.comma_first && "TK_COMMA" === _ && l.just_added_newline() && "," === l.previous_line.last() && (l.previous_line.pop(), R(), l.add_token(","), l.space_before_token = !0), e = e || h.text, R(), l.add_token(e))
            }
            ...
            function v(e) {
                u = c ? (t.push(c), c) : E(null, e), c = E(u, e)
            }
            ...
            function A(e) {
                return Y(e, [Z.Expression, Z.ForInitializer, Z.Conditional])
            }

            function k() {
                0 < t.length && (u = c, c = t.pop(), u.mode === Z.Statement && l.remove_redundant_indentation(u))
            }

            function y() {
                return c.parent.mode === Z.ObjectLiteral && c.mode === Z.Statement && (":" === c.last_text && 0 === c.ternary_depth || "TK_RESERVED" === _ && Y(c.last_text, ["get", "set"]))
            }

            function O() {
                return !!("TK_RESERVED" === _ && Y(c.last_text, ["const", "let", "const"]) && "TK_WORD" === h.type || "TK_RESERVED" === _ && "do" === c.last_text || "TK_RESERVED" === _ && "return" === c.last_text && !h.wanted_newline || "TK_RESERVED" === _ && "else" === c.last_text && ("TK_RESERVED" !== h.type || "if" !== h.text) || "TK_END_EXPR" === _ && (u.mode === Z.ForInitializer || u.mode === Z.Conditional) || "TK_WORD" === _ && c.mode === Z.BlockStatement && !c.in_case && "--" !== h.text && "++" !== h.text && "function" !== a && "TK_WORD" !== h.type && "TK_RESERVED" !== h.type || c.mode === Z.ObjectLiteral && (":" === c.last_text && 0 === c.ternary_depth || "TK_RESERVED" === _ && Y(c.last_text, ["get", "set"]))) && (v(Z.Statement), b(), "TK_RESERVED" === _ && Y(c.last_text, ["const", "let", "const"]) && "TK_WORD" === h.type && (c.declaration_statement = !0), y() || w("TK_RESERVED" === h.type && Y(h.text, ["do", "for", "if", "while"])), !0)
            }

            function N(e) {
                return Y(e, ["case", "return", "do", "if", "throw", "else"])
            }
        ...
        function q(t, n) {
            ...
            this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function () {
                ...
                if (!e.multiline_frame && e.mode !== Z.ForInitializer && e.mode !== Z.Conditional) for (var t = e.start_line_index, n = i.length; t < n;) i[t].remove_indent(), t++
        ...
        function ee(k, y, e) {
            ...
            var I, V, P, B, j, M,
                U = this.line_starters.concat(["do", "in", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await"]),
                W = /([\s\S]*?)((?:\*\/)|$)/g, z = /([^\n\r\u2028\u2029]*)/g, G = /\/\* beautify( \w+[:]\w+)+ \*\//g,
                X = / (\w+)[:](\w+)/g, F = /([\s\S]*?)((?:\/\*\sbeautify\signore:end\s\*\/)|$)/g,
                $ = /((<\?php|<\?=)[\s\S]*?\?>)|(<%[\s\S]*?%>)/g;

            function _() {
                var e, t, n = [];
                if (I = 0, V = "", M <= j) return ["", "TK_EOF"];
                t = B.length ? B[B.length - 1] : new J("TK_START_BLOCK", "{");
                var i = k.charAt(j);
                for (j += 1; Y(i, O);) {
                ...
                if (n.length && (V = n.join("")), N.test(i)) {
                    var r = !0, s = !0, _ = N;
                    for ("0" === i && j < M && /[Xxo]/.test(k.charAt(j)) ? (s = r = !1, i += k.charAt(j), j += 1, _ = /[o]/.test(k.charAt(j)) ? D : C) : (i = "", j -= 1); j < M && _.test(k.charAt(j));) i += k.charAt(j), j += 1, r && j < M && "." === k.charAt(j) && (i += k.charAt(j), j += 1, r = !1), s && j < M && /[Ee]/.test(k.charAt(j)) && (i += k.charAt(j), (j += 1) < M && /[+-]/.test(k.charAt(j)) && (i += k.charAt(j), j += 1), r = s = !1);
                    return [i, "TK_WORD"]
                }
                if (Q.isIdentifierStart(k.charCodeAt(j - 1))) {
                    if (j < M) for (; Q.isIdentifierChar(k.charCodeAt(j)) && (i += k.charAt(j), (j += 1) !== M);) ;
                    return "TK_DOT" === t.type || "TK_RESERVED" === t.type && Y(t.text, ["set", "get"]) || !Y(i, U) ? [i, "TK_WORD"] : "in" === i ? [i, "TK_OPERATOR"] : [i, "TK_RESERVED"]
                }
                ...
                if ("/" === i) {
                    ...
                    if ("*" === k.charAt(j)) {
                        ...
                        return l && "start" === l.ignore && (F.lastIndex = j, a += (o = F.exec(k))[0], j += o[0].length), [a = a.replace(Q.lineBreak, "\n"), "TK_BLOCK_COMMENT", l]
                    }
                    if ("/" === k.charAt(j)) {
                        j += 1, z.lastIndex = j;
                        var h = z.exec(k);
                        return a = "//" + h[0], j += h[0].length, [a, "TK_COMMENT"]
                    }
                }
                if ("`" === i || "'" === i || '"' === i || ("/" === i || y.e4x && "<" === i && k.slice(j - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && Y(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && Y(t.parent.text, ["if", "while", "for"]) || Y(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var c = i, u = !1, p = !1;
                    if (e = i, "/" === c) for (var d = !1; j < M && (u || d || k.charAt(j) !== c) && !Q.newline.test(k.charAt(j));) e += k.charAt(j), u ? u = !1 : (u = "\\" === k.charAt(j), "[" === k.charAt(j) ? d = !0 : "]" === k.charAt(j) && (d = !1)), j += 1; else if (y.e4x && "<" === c) {
                        var f = /<(\/?)([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/g,
                            T = k.slice(j - 1), E = f.exec(T);
                        if (E && 0 === E.index) {
                            for (var g = E[2], x = 0; E;) {
                                var w = !!E[1], K = E[2], R = !!E[E.length - 1] || "![CDATA[" === K.slice(0, 8);
                    ...
                    } else for (; j < M && (u || k.charAt(j) !== c && ("`" === c || !Q.newline.test(k.charAt(j))));) (u || "`" === c) && Q.newline.test(k.charAt(j)) ? ("\r" === k.charAt(j) && "\n" === k.charAt(j + 1) && (j += 1), e += "\n") : e += k.charAt(j), u = u ? ("x" !== k.charAt(j) && "u" !== k.charAt(j) || (p = !0), !1) : "\\" === k.charAt(j), j += 1;
                    if (p && y.unescape_strings && (e = function A(e) {
                        ...
                        return i
                    }(e)), j < M && k.charAt(j) === c && (e += c, j += 1, "/" === c)) for (; j < M && Q.isIdentifierStart(k.charCodeAt(j));) e += k.charAt(j), j += 1;
                    return [e, "TK_STRING"]
                }
                if ("#" === i) {
                    if (0 === B.length && "!" === k.charAt(j)) {
                        for (e = i; j < M && "\n" !== i;) e += i = k.charAt(j), j += 1;
                        return [H(e) + "\n", "TK_UNKNOWN"]
                    }
                    var b = "#";
            ...
            this.tokenize = function () {
                ...
                for (var i = null, r = [], s = []; !t || "TK_EOF" !== t.type;) {
                    for (n = _(), e = new J(n[1], n[0], I, V); "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;) "TK_BLOCK_COMMENT" === e.type && (e.directives = n[2]), s.push(e), n = _(), e = new J(n[1], n[0], I, V);
                    s.length && (e.comments_before = s, s = []), "TK_START_BLOCK" === e.type || "TK_START_EXPR" === e.type ? (e.parent = t, r.push(i), i = e) : ("TK_END_BLOCK" === e.type || "TK_END_EXPR" === e.type) && i && ("]" === e.text && "[" === i.text || ")" === e.text && "(" === i.text || "}" === e.text && "{" === i.text) && (e.parent = i.parent, i = r.pop()), B.push(e), t = e
                }
                return B
            }
        }
        ...
        return {
            run: function N(e, t) {
                ...
                for ((t = t || {}).wrap_line_length !== undefined && 0 !== parseInt(t.wrap_line_length, 10) || t.max_char === undefined || 0 === parseInt(t.max_char, 10) || (t.wrap_line_length = t.max_char), i = t.indent_inner_html !== undefined && t.indent_inner_html, r = t.indent_size === undefined ? 4 : parseInt(t.indent_size, 10), T = t.indent_char === undefined ? " " : t.indent_char, a = t.brace_style === undefined ? "collapse" : t.brace_style, s = 0 === parseInt(t.wrap_line_length, 10) ? 32786 : parseInt(t.wrap_line_length || 250, 10), E = t.unformatted || ["a", "span", "img", "bdo", "em", "strong", "dfn", "code", "samp", "kbd", "const", "cite", "abbr", "acronym", "q", "sub", "sup", "tt", "i", "b", "big", "small", "u", "s", "strike", "font", "ins", "del", "address", "pre"], o = t.preserve_newlines === undefined || t.preserve_newlines, l = o ? isNaN(parseInt(t.max_preserve_newlines, 10)) ? 32786 : parseInt(t.max_preserve_newlines, 10) : 0, g = t.indent_handlebars !== undefined && t.indent_handlebars, x = t.wrap_attributes === undefined ? "auto" : t.wrap_attributes, w = t.wrap_attributes_indent_size === undefined ? r : parseInt(t.wrap_attributes_indent_size, 10) || r, h = t.end_with_newline !== undefined && t.end_with_newline, c = Array.isArray(t.extra_liners) ? t.extra_liners.concat() : "string" == typeof t.extra_liners ? t.extra_liners.split(",") : "head,body,/html".split(","), t.indent_with_tabs && (T = "\t", r = 1), (n = new function k() {
                    ...
                    switch (n.token_type) {
                        ...
                        case"TK_SCRIPT":
                            if ("" !== n.token_text) {
                                ...
                                var K = n.token_text, R = void 0, m = 1;
                                "TK_SCRIPT" === n.token_type ? R = O : "TK_STYLE" === n.token_type && (R = y), "keep" === t.indent_scripts ? m = 0 : "separate" === t.indent_scripts && (m = -n.indent_level);
                                var b = n.get_full_indent(m);
                                if (R) K = R(K.replace(/^\s*/, b), t); else {
