...
!function (o, t) {
    ...
    k = k && k.hasOwnProperty("default") ? k["default"] : k, Object.assign(k.POPUP_TEMPLATES, {
        ...
        function i(o) {
            ...
            var a = r.find(".fr-".concat(o, "-color .fr-select-color"));
            for (a.find(".fr-selected-color").remove(), a.removeClass("fr-active-item"), a.not('[data-param1="REMOVE"]').attr("aria-selected", !1); e.get(0) !== g.el;) {
                if ("transparent" !== e.css(t) && "rgba(0, 0, 0, 0)" !== e.css(t)) {
                    var c = r.find(".fr-".concat(o, '-color .fr-select-color[data-param1="').concat(g.helpers.RGBToHex(e.css(t)), '"]'));
                    c.append('<span class="fr-selected-color" aria-hidden="true">\uf00c</span>'), c.addClass("fr-active-item").attr("aria-selected", !0);
                    break
                }
                e = e.parent()
            }
        ...
        return {
            showColorsPopup: function p(o) {
                ...
                if (r || (r = function n(o) {
                    ...
                    var a = g.popups.create("".concat(o, ".picker"), r);
                    return function c(C, b) {
                        g.events.on("popup.tab", function (o) {
                            ...
                            var r = o.which, e = !0;
                            if (k.KEYCODE.TAB === r) {
                                var a = C.find(".fr-buttons");
                                e = !g.accessibility.focusToolbar(a, !!o.shiftKey)
                                ...
                                if (t.is("span.fr-select-color")) {
                                    var c = t.parent().find("span.fr-select-color"), n = c.index(t),
                                        l = g.opts.colorsStep, s = Math.floor(c.length / l), i = n % l,
                    ...
                    var e = g.button.getPosition(t), a = e.left, c = e.top;
                    g.popups.show("".concat(o, ".picker"), a, c, t.outerHeight())
                } else g.position.forSelection(r), g.popups.show("".concat(o, ".picker"))
            }, background: e, customColor: function c(o) {
                var t = g.popups.get("".concat(o, "Color.picker")).find(".fr-color-hex-layer input");
                if (t.length) {
                    var r = t.val();
                    "background" === o ? e(r) : a(r)
                }
            }, text: a, back: function o() {
