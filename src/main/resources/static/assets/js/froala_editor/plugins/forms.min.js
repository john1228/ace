...
!function (t, e) {
    ...
    t = t && t.hasOwnProperty("default") ? t["default"] : t, Object.assign(t.POPUP_TEMPLATES, {
    ...
    }), t.PLUGINS.forms = function (i) {
        var r, u = i.$;

        function e(t) {
            t.preventDefault(), i.selection.clear(), u(this).data("mousedown", !0)
        }

        function o(t) {
            u(this).data("mousedown") && (t.stopPropagation(), u(this).removeData("mousedown"), f(r = this)), t.preventDefault()
        }
        ...
        function f(t) {
            var e = i.popups.get("forms.edit");
            e || (e = function s() {
                var t = "";
                0 < i.opts.formEditButtons.length && (t = '<div class="fr-buttons">'.concat(i.button.buildList(i.opts.formEditButtons), "</div>"));
                var e = {buttons: t}, o = i.popups.create("forms.edit", e);
                return i.$wp && i.events.$on(i.$wp, "scroll.link-edit", function () {
                    p() && i.popups.isVisible("forms.edit") && f(p())
                }), o
            }());
            var o = u(r = t);
            ...
            i.popups.show("forms.edit", n, a, o.outerHeight())
        }

        function s() {
            var t = i.popups.get("forms.update"), e = p();
            if (e) {
                var o = u(e);
        ...
        function l(t) {
            if (t) return i.popups.onRefresh("forms.update", s), i.popups.onHide("forms.update", d), !0;
            var e = "";
            1 <= i.opts.formUpdateButtons.length && (e = '<div class="fr-buttons">'.concat(i.button.buildList(i.opts.formUpdateButtons), "</div>"));
            var o = 0, n = {
                buttons: e,
            ...
            return i.popups.create("forms.update", n)
        }

        return {
            _init: function c() {
                !function t() {
                    i.events.$on(i.$el, i._mousedown, "input, textarea, button", e), i.events.$on(i.$el, i._mouseup, "input, textarea, button", o), i.events.$on(i.$el, "touchmove", "input, textarea, button", a), i.events.$on(i.$el, i._mouseup, n), i.events.$on(i.$win, i._mouseup, n), l(!0)
                }(), i.events.$on(i.$el, "submit", "form", function (t) {
                    return t.preventDefault(), !1
                })
            }, updateInput: function m() {
                var t = i.popups.get("forms.update"), e = p();
                if (e) {
                    var o = u(e), n = t.find('input[type="text"][name="text"]').val() || "";
                    n.length && (o.is("button") ? o.text(n) : o.attr("placeholder", n)), i.popups.hide("forms.update"), f(e)
                }
            }, getInput: p, applyStyle: function v(t, e, o) {
                void 0 === e && (e = i.opts.formStyles), void 0 === o && (o = i.opts.formMultipleStyles);
                var n = p();
                if (!n) return !1;
                if (!o) {
                    var a = Object.keys(e);
                    a.splice(a.indexOf(t), 1), u(n).removeClass(a.join(" "))
                }
                u(n).toggleClass(t)
            }, showUpdatePopup: function h() {
                var t = p();
                if (t) {
                    var e = u(t), o = i.popups.get("forms.update");
                    o || (o = l()), i.popups.isVisible("forms.update") || i.popups.refresh("forms.update"), i.popups.setContainer("forms.update", i.$sc);
                    var n = e.offset().left + e.outerWidth() / 2, a = e.offset().top + e.outerHeight();
                    i.popups.show("forms.update", n, a, e.outerHeight())
                }
            }, showEditPopup: f, back: function b() {
                i.events.disableBlur(), i.selection.restore(), i.events.enableBlur();
                var t = p();
                t && i.$wp && ("BUTTON" === t.tagName && i.selection.restore(), f(t))
            }
        }
    ...
    }), t.DefineIcon("inputEdit", {NAME: "edit"}), t.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
    ...
    }), t.DefineIcon("inputBack", {NAME: "arrow-left", SVG_KEY: "back"}), t.RegisterCommand("inputBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
