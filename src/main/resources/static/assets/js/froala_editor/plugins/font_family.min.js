...
!function (e, t) {
    ...
    e = e && e.hasOwnProperty("default") ? e["default"] : e, Object.assign(e.DEFAULTS, {
    ...
    }), e.PLUGINS.fontFamily = function (i) {
        var o = i.$;
        ...
        function n() {
            var e = r(o(i.selection.element()).css("font-family")), t = [];
        ...
        return {
            apply: function t(e) {
                ...
                if (i.opts.fontFamilySelection) {
                    var t = o(i.selection.element()).css("font-family").replace(/(sans-serif|serif|monospace|cursive|fantasy)/gi, "").replace(/"|'|/g, "").split(",");
                    e.find("> span").text(i.opts.fontFamily[n()] || t[0] || i.language.translate(i.opts.fontFamilyDefaultSelection))
                }
            }
        }
