    ...
    a = a && a.hasOwnProperty("default") ? a["default"] : a, Object.assign(a.DEFAULTS, {
        ...
        return {
            _init: function a() {
                ...
                n.selection.save();
                for (var l = i(s[0]).hasClass(a), o = 0; o < s.length; o++) i(s[o]).removeClass(r).toggleClass(a, !l), i(s[o]).hasClass("fr-temp-div") && i(s[o]).removeClass("fr-temp-div"), "" === i(s[o]).attr("class") && i(s[o]).removeAttr("class");
        ...
        type: "dropdown", html: function () {
            ...
            for (var t in e) e.hasOwnProperty(t) && (a += '<li role="presentation"><a class="fr-command ' + t + '" tabIndex="-1" role="option" data-cmd="paragraphStyle" data-param1="' + t + '" title="' + this.language.translate(e[t]) + '">' + this.language.translate(e[t]) + "</a></li>");
            return a += "</ul>"
