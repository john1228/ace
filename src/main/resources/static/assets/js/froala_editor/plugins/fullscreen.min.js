...
!function (e, t) {
    ...
    "use strict";
    (e = e && e.hasOwnProperty("default") ? e["default"] : e).PLUGINS.fullscreen = function (r) {
        var t, o, s, n, i = r.$;
        ...
        function e() {
            if (r.helpers.isIOS() && r.core.hasFocus()) return r.$el.blur(), setTimeout(f, 250), !1;
            t = r.helpers.scrollTop(), r.$box.toggleClass("fr-fullscreen"), i("body").first().toggleClass("fr-fullscreen"), r.helpers.isMobile() && (r.$tb.data("parent", r.$tb.parent()), r.$box.prepend(r.$tb), r.$tb.data("sticky-dummy") && r.$tb.after(r.$tb.data("sticky-dummy"))), o = r.opts.height, s = r.opts.heightMax, n = r.opts.zIndex, r.opts.height = r.o_win.innerHeight - (r.opts.toolbarInline ? 0 : r.$tb.outerHeight() + (r.$second_tb ? r.$second_tb.outerHeight() : 0)), r.opts.zIndex = 2147483641, r.opts.heightMax = null, r.size.refresh(), r.opts.toolbarInline && r.toolbar.showInline();
        ...
        return {
            _init: function d() {
                if (!r.$wp) return !1;
                r.events.$on(i(r.o_win), "resize", function () {
                    a() && (l(), e())
                }), r.events.on("toolbar.hide", function () {
                    if (a() && r.helpers.isMobile()) return !1
                }), r.events.on("position.refresh", function () {
                    if (r.helpers.isIOS()) return !a()
                }), r.events.on("destroy", function () {
                    a() && l()
                }, !0)
            }, toggle: f, refresh: c, isActive: a
        }
