...
!function (e, t) {
    ...
    "use strict";
    o = o && o.hasOwnProperty("default") ? o["default"] : o, Object.assign(o.DEFAULTS, {
        inlineStyles: {
            "Big Red": "font-size: 20px; color: red;",
            "Small Blue": "font-size: 14px; color: blue;"
        }
    }), o.PLUGINS.inlineStyle = function (i) {
        return {
            apply: function a(e) {
                if ("" !== i.selection.text()) for (var t = e.split(";"), n = 0; n < t.length; n++) {
                    var l = t[n].split(":");
                    t[n].length && 2 == l.length && i.format.applyStyle(l[0].trim(), l[1].trim())
                } else i.html.insert('<span style="' + e + '">' + o.INVISIBLE_SPACE + o.MARKERS + "</span>")
            }
        }
    }, o.RegisterCommand("inlineStyle", {
    ...
    }), o.DefineIcon("inlineStyle", {NAME: "paint-brush", SVG_KEY: "inlineStyle"})
});