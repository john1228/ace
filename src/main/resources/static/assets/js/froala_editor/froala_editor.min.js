...
!function (e, t) {
    ...
    H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), H.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(H.LinkRegExCommon, ")"), H.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"), H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd), H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], H.MAIL_REGEX = /.+@.+\..+/i, H.MODULES.helpers = function (i) {
        ...
        function v(e, t, n) {
            ...
            if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(H.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(H.MARKERS))); else {
                var o = e, i = "";
            ...
            enter: function b(e) {
                ...
                0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), i(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
                    ...
                    if (null === o) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(H.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(H.MARKERS)); else {
                        if (u.node.isBlock(o)) if ("PRE" === o.tagName && (t = !0), t) h(e).remove(), h(o).prepend("<br>".concat(H.MARKERS)); else {
        ...
        function g() {
            ...
            v = f.$wp.find("> div").first(), b = v.find("> a"), "rtl" === f.opts.direction && v.css("left", "auto").css("right", 0).attr("direction", "rtl"), e++
        }
        ...
        function b(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (o) (v(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) && b(o.firstChild, t, n); else {
        ...
        return {
            _init: function t() {
                ...
                if (!r) for (var t in r = {}, H.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call(H.SHORTCUTS_MAP, t) && 0 <= a.opts.shortcutsEnabled.indexOf(H.SHORTCUTS_MAP[t].cmd) && (r["".concat(H.SHORTCUTS_MAP[t].cmd, ".").concat(H.SHORTCUTS_MAP[t].val || "")] = {
        ...
        return {
            _init: function o() {
                ...
                n.setRequestHeader("X-CSRF-Token", $('meta[name="_csrf"]').attr('content'));
                return n
        ...
        return {
            _init: function p() {
                ...
                m.opts.toolbarInline || m.opts.toolbarBottom || (m.$second_tb = b(m.doc.createElement("div")).attr("class", "second-toolbar"), m.$box.append(m.$second_tb), (!1 !== m.ul || m.opts.attribution)), m.opts.toolbarContainer ? (m.shared.$tb ? (m.$tb = m.shared.$tb, m.opts.toolbarInline && s()) : (m.shared.$tb = b(m.doc.createElement("DIV")), m.shared.$tb.addClass("fr-toolbar"), m.$tb = m.shared.$tb, b(m.opts.toolbarContainer).append(m.$tb), d(), m.$tb.data("instance", m)), m.opts.toolbarInline ? m.$box.addClass("fr-inline") : m.$box.addClass("fr-basic"), m.events.on("focus", function () {
    ...
    h.fn = h.prototype = {
        constructor: h, length: 0, contains: function (e) {
            ...
            } else if (e instanceof h || Array.isArray(e)) for (var o = 0; o < e.length; o++) this.append(e[o]); else this[0].appendChild(e);
            return this
        }, prepend: function (e) {
            if (0 == this.length) return this;
            if ("string" == typeof e) for (var t = 0; t < this.length; t++) {
