...
!function (e, t) {
    ...
    Fe.RegisterPlugins = function (e) {
        ...
        htmlUntouched: !1,
        fullPage: !1
    }), Fe.HTML5Map = {B: "STRONG", I: "EM", STRIKE: "S"}, Fe.MODULES.clean = function (f) {
        var d, p, u, h, g = f.$;
        ...
        function T(e) {
            ...
            !function c(e) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE && Fe.HTML5Map[e.tagName] && "" === f.node.attributes(e)) {
                    var t = Fe.HTML5Map[e.tagName], n = "<".concat(t, ">").concat(e.innerHTML, "</").concat(t, ">");
    ...
    Fe.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), Fe.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", Fe.LinkRegExTLD = "((".concat(Fe.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), Fe.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(Fe.LinkRegExCommon, ")"), Fe.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(Fe.LinkRegExCommon, ")"), Fe.LinkRegExWWW = "(www\\.".concat(Fe.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), Fe.LinkRegEx = "(".concat(Fe.LinkRegExTLD, "|").concat(Fe.LinkRegExHTTP, "|").concat(Fe.LinkRegExWWW, "|").concat(Fe.LinkRegExAuth, ")").concat(Fe.LinkRegExEnd), Fe.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Fe.MAIL_REGEX = /.+@.+\..+/i, Fe.MODULES.helpers = function (o) {
    ...
    }, Object.assign(Fe.DEFAULTS, {indentMargin: 20}), Fe.COMMANDS = {
        bold: {
            title: "Bold",
            toggle: !0,
            refresh: function (e) {
        ...
        function n(e, t) {
            if (!1 !== i.events.trigger("commands.before", s.merge([e], t || []))) {
                var n = Fe.COMMANDS[e] && Fe.COMMANDS[e].callback || o[e], r = !0, a = !1;
        ...
        return Object.assign(c, {
            exec: n, _init: function f() {
                i.events.on("keydown", function (e) {
                    ...
                    var t = i.selection.element();
                    if (t && "HR" === t.tagName) if (e.which === Fe.KEYCODE.ARROW_LEFT || e.which === Fe.KEYCODE.ARROW_UP) {
        ...
        return {
            _startEnter: function E(e) {
                ...
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var c = "";
                    for (c = l.parentNode && "LI" === l.parentNode.tagName ? "".concat(s, "<li>").concat(Fe.MARKERS, "<br>").concat(i) : o ? "".concat(s, "<").concat(o, ">").concat(Fe.MARKERS, "<br></").concat(o, ">").concat(i) : "".concat(s + Fe.MARKERS, "<br>").concat(i); ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
                ...
                if (r) {
                    ...
                    if (s === g.el) return !1;
                    if (s = s.nextSibling, g.node.isBlock(s)) Fe.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith(Fe.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove()); else for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(e).replaceWith(Fe.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;) m(n).append(m(s)), s = s.nextSibling
                }
            }
        }
        ...
        function f(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    } else h(n.parentNode).after(Fe.MARKERS), h(n.parentNode).remove(); else h(n).after(Fe.MARKERS)
            ...
            } else if (Fe.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) h(e).replaceWith(Fe.MARKERS), h(n).remove(); else if (u.node.isEmpty(n) && !u.node.isList(n)) h(n).remove(), h(e).replaceWith(Fe.MARKERS); else {
        ...
        function s(e) {
            ...
            if (null !== n) {
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && o && Fe.NO_DELETE_TAGS.indexOf(o.tagName) < 0) if (u.node.isDeletable(o)) h(o).remove(), h(e).replaceWith(Fe.MARKERS); else if (u.node.isBlock(o) && u.node.isEditable(o)) if (u.node.isList(o)) if (u.node.isEmpty(n, !0)) h(n).remove(), h(o).find("li").first().prepend(Fe.MARKERS); else {
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n)) if (n.nextSibling) {
                ...
                if (c(e)) u.cursorLists._del(e); else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && Fe.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(), s(e));
                return
            }
            ...
            } else if (Fe.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) h(e).replaceWith(Fe.MARKERS), h(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (h(n).find("li").first().prepend(e), u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend(Fe.MARKERS), h(e).remove()); else if ((t = u.node.contents(n)) && "BR" === t[0].tagName && h(t[0]).remove(), t && "BLOCKQUOTE" === n.tagName) {
                var r = t[0];
        ...
        function l(e, t, n) {
            ...
            if (null === a) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat(Fe.MARKERS)) : h(e).replaceWith("<br>".concat(Fe.MARKERS, "<br>")); else {
                var o = e, i = "";
        ...
        function v(e, t, n) {
            ...
            if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(Fe.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(Fe.MARKERS))); else {
                var a = e, o = "";
                ...
                if ("BLOCKQUOTE" === r.tagName) if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()), t) o = i + o + Fe.MARKERS + s; else {
        ...
        return {
            enter: function b(e) {
                ...
                0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), o(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : i(t) ? !c(t) || e || r ? function s(e, t, n) {
                    ...
                    if (null === a) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(Fe.MARKERS)); else {
                        if (u.node.isBlock(a)) if ("PRE" === a.tagName && (t = !0), t) h(e).remove(), h(a).prepend("<br>".concat(Fe.MARKERS)); else {
                ...
                return o(t) ? c(t) && g(t, h(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = f(t) : i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n)) if (i && Fe.NO_DELETE_TAGS.indexOf(i.tagName) < 0) {
                            if (u.node.isDeletable(i)) h(i).remove(), h(e).replaceWith(Fe.MARKERS); else if (u.node.isEditable(i)) if (u.node.isBlock(i)) if (u.node.isEmpty(i) && !u.node.isList(i)) h(i).remove(), h(e).after(u.opts.keepFormatOnDelete ? Fe.INVISIBLE_SPACE : ""); else {
        ...
        return {
            _init: function w() {
                ...
                var d = new Image;
                !0 === f.ul && (g()), !0 === f.ul && (f.events.on("contentChanged", function () {
                    (function e() {
        ...
        function b(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (a) (v(a).find(".fr-marker").length || "UL" === a.tagName || "OL" === a.tagName) && b(a.firstChild, t, n); else {
        ...
        function r(e, t) {
            ...
            !function d(e, t, n, r) {
                for (var a = m.node.contents(e.get(0)), o = 0; o < a.length; o++) {
                    var i = a[o];
                    if (m.node.hasClass(i, "fr-marker")) t = (t + 1) % 2; else if (t) if (0 < v(i).find(".fr-marker").length) t = d(v(i), t, n, r); else {
        ...
        function t(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                    if (m.node.isEmpty(l.get(0))) s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(Fe.INVISIBLE_SPACE).concat(Fe.MARKERS)), l.replaceWith(s); else {
                        var c = {};
        ...
        return {
            text: s, get: T, ranges: d, clear: S, element: function l() {
                ...
                if (function E() {
                    ...
                    if (s.length) A.$el.find(".fr-marker").remove(), s.append(Fe.INVISIBLE_SPACE + Fe.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html()); else for (A.$el.find("table").filter(function () {
    ...
    }, Object.assign(Fe.DEFAULTS, {language: null}), Fe.LANGUAGE = {}, Fe.MODULES.language = function (e) {
        var t;
        return {
            _init: function n() {
    ...
    }, Object.assign(Fe.DEFAULTS, {placeholderText: "Type something"}), Fe.MODULES.placeholder = function (f) {
        var p = f.$;
        ...
        function e() {
            ...
            var e = f.opts.iframe ? f.$iframe.prev().outerHeight(!0) : f.$el.prev().outerHeight(!0), t = 0, n = 0,
                r = 0, a = 0, o = 0, i = 0, s = f.node.contents(f.el), l = p(f.selection.element()).css("text-align");
        ...
        function o(e) {
            ...
            var l = u();
            for (l += ",".concat(Fe.VOID_ELEMENTS.join(",")), l += ", .fr-inner", l += ",".concat(N.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"), t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
        ...
        IME: 229
    }, Object.assign(Fe.DEFAULTS, {enter: Fe.ENTER_P, multiLine: !0, tabSpaces: 0}), Fe.MODULES.keys = function (p) {
        var u, n, r, t = p.$, h = !1;
        ...
        function s(e) {
            ...
            h = !1;
            var r = b(n) && !m(e) && !e.altKey, a = n === Fe.KEYCODE.BACKSPACE || n === Fe.KEYCODE.DELETE;
        ...
        function T(e) {
            var t = p.el.childNodes, n = p.html.defaultTag();
        ...
        function a(e, t, n) {
            ...
            if ("string" == typeof d && (e = d), "" !== e) {
                ...
                if (L.opts.enter === Fe.ENTER_BR) for (r = (a = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (o = a[r]).attributes.length && (o.outerHTML = o.innerHTML + (o.nextSibling && !L.node.isEmpty(o) ? "<br>" : "")); else if (L.opts.enter === Fe.ENTER_DIV) for (r = (a = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (o = a[r]).attributes.length && (o.outerHTML = "<div>".concat(o.innerHTML, "</div>")); else L.opts.enter === Fe.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
        ...
        return {
            _init: function t() {
                ...
                if (!r) for (var t in r = {}, Fe.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call(Fe.SHORTCUTS_MAP, t) && 0 <= i.opts.shortcutsEnabled.indexOf(Fe.SHORTCUTS_MAP[t].cmd) && (r["".concat(Fe.SHORTCUTS_MAP[t].cmd, ".").concat(Fe.SHORTCUTS_MAP[t].val || "")] = {
    ...
    }, Fe.POPUP_TEMPLATES = {"text.edit": "[_EDIT_]"}, Fe.RegisterTemplate = function (e, t) {
    ...
    }, Object.assign(Fe.DEFAULTS, {tooltips: !0}), Fe.MODULES.tooltip = function (o) {
        var i = o.$;
                ...
                for (var r in e) {
                    ...
                    if (a.buttons) {
                        for (var o = "", i = "", s = 0, l = "left", c = Fe.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < a.buttons.length; d++) {
                            var f = a.buttons[d], p = Fe.COMMANDS[f];
        ...
        Fe.ICONS[e] = t
    }, Object.assign(Fe.DEFAULTS, {iconsTemplate: "svg"}), Fe.MODULES.icon = function (a) {
        return {
            create: function o(n) {
                var e = null, r = Fe.ICONS[n];
                if (void 0 !== r) {
                ...
                var t = Fe.ICONS[e], n = a.opts.iconsTemplate;
    ...
    var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"], d = ["webkit", "moz", "ms", "o"],
        ...
        r = ["focus", "blur", "click"], l = {}, p = function p(e, t) {
            return {
                altKey: e.altKey,
                bubbles: e.bubbles,
            ...
            return function (e) {
                var t = e.target;
                if (r) for (r = m(r); t && t !== this;) t.matches && t.matches(m(r)) && n.call(t, p(e, t)), t = t.parentNode; else u(t) && n.call(t, p(e, t))
            }
        }, g = function g(e, t) {
            return new E(e, t)
        }, m = function m(e) {
    ...
    g.fn = g.prototype = {
        constructor: g, length: 0, contains: function (e) {
            if (!e) return !1;
            if (Array.isArray(e)) {
            ...
            if ("string" == typeof e) {
                ...
                if (n < t.length && (e = document.createElement(t[n].trim()), n++), "string" != typeof e) for (var r = b(e); n < t.length; n++) {
                    t[n] = t[n].trim();
                    var a = t[n].split("=");
            ...
            for (var e = b(), t = 0; t < this.length; t++) for (var n = this[t].childNodes, r = 0; r < n.length; r++) e.push(n[r]);
            return e
        }, attr: function (e, t) {
            if ("object" === Be(e)) {
            ...
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && -1 < (" " + b(this).stripAndCollapse(b(this).getClass(n)) + " ").indexOf(t)) return !0;
            return !1
            ...
            var t = b();
            if ("string" != typeof e) {
                for (var n = 0; n < e.length; n++) for (var r = 0; r < this.length; r++) if (this[r] !== e[n] && b(this[r]).contains(e[n])) {
                    t.push(e[n]);
                    break
                }
                return t
            ...
            for (var e = b(), t = 0; t < this.length; t++) for (var n = this[t].children, r = 0; r < n.length; r++) e.push(n[r]);
            return e
        }, not: function (e) {
            if ("string" == typeof e) for (var t = this.length - 1; 0 <= t; t--) this[t].matches(e) && this.splice(t, 1); else if (e instanceof g) {
            ...
            if (t) if ("string" == typeof t) for (var n = 0; n < this.length; n++) {
                ...
                var a = this[0];
                if (a.nextSibling) if (t instanceof g) for (var o = 0; o < t.length; o++) a.nextSibling.parentNode.insertBefore(t[o], a.nextSibling); else a.nextSibling.parentNode.insertBefore(t, a.nextSibling); else b(a.parentNode).append(t)
            }
            return this
        }, clone: function (e) {
            ...
            if (t) if ("string" == typeof t) for (var r = 0; r < this.length; r++) {
                ...
                var o = this[0];
                if (o.parentNode) if (t instanceof g) for (var i = 0; i < t.length; i++) o.parentNode.insertBefore(t[i], o); else o.parentNode.insertBefore(t, o)
            }
            return this
        }, append: function (e) {
            if (0 == this.length) return this;
            ...
            } else if (e instanceof g || Array.isArray(e)) for (var a = 0; a < e.length; a++) this.append(e[a]); else this[0].appendChild(e);
            return this
        }, prepend: function (e) {
            if (0 == this.length) return this;
            if ("string" == typeof e) for (var t = 0; t < this.length; t++) {
            ...
            } else if (e instanceof g) for (var a = 0; a < e.length; a++) this.prepend(e[a]); else {
                var o = this[0];
            ...
            if (e && (o += parseInt(b(t).css("marginTop")) + parseInt(b(t).css("marginBottom"))), !r) for (var i in s) t.style[i] = n[i];
            return o
            ...
            if (!r) for (var a in s) n[a] = t.style[a], t.style[a] = s[a];
            var o = t.offsetWidth;
            if (e && (o += parseInt(b(t).css("marginLeft")) + parseInt(b(t).css("marginRight"))), !r) for (var i in s) t.style[i] = n[i];
            return o
        }, width: function (e) {
            ...
            for (var t = b(), n = 0; n < this.length; n++) for (var r = this[n].parentNode; r && r != document && r.matches;) e ? r.matches(e) && t.push(r) : t.push(r), r = r.parentNode;
            return t
    ...
    if (T.Bootstrap = function (e, t, n) {
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.align.options;
        ...
        plugin: "align"
    }), Object.assign(Fe.DEFAULTS, {charCounterMax: -1, charCounterCount: !0}), Fe.PLUGINS.charCounter = function (n) {
        var r, t = n.$;
        ...
        NAME: "eraser",
        SVG_KEY: "remove"
    }), Object.assign(Fe.DEFAULTS, {dragInline: !0}), Fe.PLUGINS.draggable = function (d) {
        var f, p = d.$;
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function n() {
                for (var e = null, t = 0; t < Fe.INSTANCES.length; t++) if ((e = Fe.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
        ...
        function a(e) {
            var t, n;
            d.$el.attr("contenteditable", !0);
            for (var r = 0; r < Fe.INSTANCES.length; r++) if ((t = Fe.INSTANCES[r].$el.find(".fr-dragging")).length) {
                n = Fe.INSTANCES[r];
                break
            }
            if (t.length) {
                ...
                var a = t;
                if (t.parent().is("A") && 1 === t.parent().get(0).childNodes.length && (a = t.parent()), d.core.isEmpty()) d.events.focus(); else d.$el.find(".fr-marker").replaceWith(Fe.MARKERS), d.selection.restore();
    ...
    }, Object.assign(Fe.DEFAULTS, {editInPopup: !1}), Fe.MODULES.editInPopup = function (r) {
        function e() {
    ...
    }), Object.assign(Fe.POPUP_TEMPLATES, {emoticons: "[_BUTTONS_][_CUSTOM_LAYER_]"}), Object.assign(Fe.DEFAULTS, {
        emoticonsSet: [{
            id: "people",
            name: "Smileys & People",
            code: "1f600",
    ...
    }, Object.assign(Fe.POPUP_TEMPLATES, {"file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}), Object.assign(Fe.DEFAULTS, {
        fileUpload: !0,
        fileUploadURL: null,
        ...
        plugin: "file"
    }), Fe.DefineIcon("fileBack", {NAME: "arrow-left", SVG_KEY: "back"}), Fe.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Fe.DefineIcon("inputEdit", {NAME: "edit"}), Fe.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
        refreshAfterCallback: !1,
        callback: function () {
        ...
        function N(e, t, n) {
            f.edit.on(), p && p.addClass("fr-error"), function r(e) {
                I();
        ...
        function ne(e) {
            ...
            } else if (e && e.nodeType == Node.ELEMENT_NODE) for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), a = 0; a < r.length; a++) ne(r[a])
        }
        ...
        function re(e) {
            ...
            W([new Blob([new Uint8Array(r)], {type: t[0].replace(/data\:/g, "").replace(/;base64/g, "")})], p)
        }
        ...
        function ae() {
            f.opts.imagePaste ? f.$el.find("img[data-fr-image-pasted]").each(function (e, r) {
                ...
                if (0 === r.src.indexOf("data:")) re(r); else if (0 === r.src.indexOf("blob:") || 0 === r.src.indexOf("http") && f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy) {
                    var n = new Image;
        ...
        return {
            ...
            showInsertPopup: function Ce() {
                ...
                if (t || (t = G()), k(), !t.hasClass("fr-active")) if (f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$tb), e.isVisible()) {
            ...
            insertByURL: function Le() {
                ...
                if (0 < e.val().length) {
                    ...
                    if (f.opts.imageUploadRemoteUrls && f.opts.imageCORSProxy && f.opts.imageUpload) {
                        var n = new XMLHttpRequest;
                        n.onload = function () {
                            200 == this.status ? W([new Blob([this.response], {type: this.response.type || "image/png"})], p) : N(r)
                        }, n.onerror = function () {
                            F(t, !0, [], p)
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.imageAlign.options;
    ...
    }),Fe.DefineIcon("imageBack", {NAME: "arrow-left", SVG_KEY: "back"}),Fe.RegisterCommand("imageBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }),Fe.DefineIcon("imageAlt", {NAME: "info", SVG_KEY: "imageAltText"}),Fe.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }),Fe.DefineIcon("imageSize", {NAME: "arrows-alt", SVG_KEY: "imageSize"}),Fe.RegisterCommand("imageSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
        ...
        return a[e] = "Image cannot be loaded from the passed link.", a[E] = "Error during load images request.", a[T] = "Missing imageManagerLoadURL option.", a[A] = "Parsing load response failed.", a[C] = "Missing image thumb.", a[S] = "Missing image URL.", a[n] = "Error during delete image request.", a[r] = "Missing imageManagerDeleteURL option.", {
            ...
            show: function H() {
                if (!l) {
                    var e,
                        t = '<button class="fr-command fr-btn fr-modal-more fr-not-available" id="fr-modal-more-'.concat(s.sid, '"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24""><path d="').concat(Fe.SVG.tags, '"/></svg></button><h4 data-text="true">').concat(s.language.translate("Manage Images"), '</h4></div>\n      <div class="fr-modal-tags" id="fr-modal-tags">');
    ...
    return Fe.DEFAULTS.imageInsertButtons.push("imageManager"), Fe.RegisterCommand("imageManager", {
    ...
    }), Fe.DefineIcon("linkBack", {NAME: "arrow-left", SVG_KEY: "back"}), Fe.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Object.assign(Fe.DEFAULTS, {listAdvancedTypes: !0}), Fe.PLUGINS.lists = function (f) {
        var p = f.$;
    ...
    }), Object.assign(Fe.DEFAULTS, {html2pdf: window.html2pdf}), Fe.PLUGINS.print = function (l) {
        return {
            run: function e() {
                !function s(e) {
    ...
    }, Fe.DefineIcon("print", {NAME: "print", SVG_KEY: "print"}), Fe.RegisterCommand("print", {
        title: "Print",
        undo: !1,
        focus: !1,
        plugin: "print",
        ...
        Fe.QUICK_INSERT_BUTTONS[e] = Object.assign({undo: !0}, t)
    ...
    }, Fe.DefineIcon("save", {NAME: "floppy-o", FA5NAME: "save"}), Fe.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
    ...
    }), Object.assign(Fe.POPUP_TEMPLATES, {specialCharacters: "[_BUTTONS_][_CUSTOM_LAYER_]"}), Fe.PLUGINS.specialCharacters = function (g) {
    ...
    }), Fe.DefineIcon("tableRows", {NAME: "bars", SVG_KEY: "row"}),Fe.RegisterCommand("tableRows", {
        type: "dropdown",
        focus: !1,
        title: "Row",
        options: {above: "Insert row above", below: "Insert row below", "delete": "Delete row"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.tableRows.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.tableColumns.options;
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.tableCells.options;
    ...
    }),Fe.DefineIcon("tableBack", {NAME: "arrow-left", SVG_KEY: "back"}),Fe.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.tableCellVerticalAlign.options;
        ...
        return a[1] = "Video cannot be loaded from the passed link.", a[g] = "No link in upload response.", a[m] = "Error during file upload.", a[v] = "Parsing response failed.", a[c] = "File is too large.", a[b] = "Video file type is invalid.", a[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", u.shared.vid_exit_flag = !1, {
            _init: function ee() {
                ...
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), u.helpers.isURL(e)) for (var n = 0; n < Fe.VIDEO_PROVIDERS.length; n++) {
        ...
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Fe.COMMANDS.videoAlign.options;
    ...
    }),Fe.DefineIcon("videoSize", {NAME: "arrows-alt", SVG_KEY: "imageSize"}),Fe.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }),Fe.DefineIcon("videoBack", {NAME: "arrow-left", SVG_KEY: "back"}),Fe.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        function t(e) {
            ...
            e || (A.opts.wordAllowedStyleProps = []), 0 === a.indexOf("<colgroup>") && (a = "<table>" + a + "</table>"), a = function p(e, t) {
                ...
                g(a, function (e) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        if (S(e)) {
                            var t = e.parentNode, n = e.previousSibling, r = function v(e, t, n) {
                                var r = /[0-9a-zA-Z]./gi;
                                var a = !1;
                                var o = !1;
                                var i = !1;
                                ...
                                for (; e;) {
                                    ...
                                    if ((n = n || u) < u) d = v(e, t, u), p += d.el.outerHTML, e = d.currentNode; else {
                                        if (u < n) break;
                    ...
                    return a = e, A.opts.wordPasteModal ? function o() {
                        if (!s) {
                            var e = '<h4><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 74.95 73.23" style="height: 25px; vertical-align: text-bottom; margin-right: 5px; display: inline-block"><defs><style>.a{fill:#2a5699;}.b{fill:#fff;}</style></defs><path class="a" d="M615.15,827.22h5.09V834c9.11.05,18.21-.09,27.32.05a2.93,2.93,0,0,1,3.29,3.25c.14,16.77,0,33.56.09,50.33-.09,1.72.17,3.63-.83,5.15-1.24.89-2.85.78-4.3.84-8.52,0-17,0-25.56,0v6.81h-5.32c-13-2.37-26-4.54-38.94-6.81q0-29.8,0-59.59c13.05-2.28,26.11-4.5,39.17-6.83Z" transform="translate(-575.97 -827.22)"/><path class="b" d="M620.24,836.59h28.1v54.49h-28.1v-6.81h22.14v-3.41H620.24v-4.26h22.14V873.2H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24v-4.26h22.14v-3.41H620.24V846h22.14v-3.41H620.24Zm-26.67,15c1.62-.09,3.24-.16,4.85-.25,1.13,5.75,2.29,11.49,3.52,17.21,1-5.91,2-11.8,3.06-17.7,1.7-.06,3.41-.15,5.1-.26-1.92,8.25-3.61,16.57-5.71,24.77-1.42.74-3.55,0-5.24.09-1.13-5.64-2.45-11.24-3.47-16.9-1,5.5-2.29,10.95-3.43,16.42q-2.45-.13-4.92-.3c-1.41-7.49-3.07-14.93-4.39-22.44l4.38-.18c.88,5.42,1.87,10.82,2.64,16.25,1.2-5.57,2.43-11.14,3.62-16.71Z" transform="translate(-575.97 -827.22)"/></svg> ' + A.language.translate("Word Paste Detected") + "</h4>",
                                ...
                                }(), n = A.modals.create(l, e, t), r = n.$body;
